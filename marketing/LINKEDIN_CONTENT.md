...
in English in both languages.

---
## Week 1 · Post 1 (Educational)
...
Carousel suggestion: 5 slides — "Where does your AI send your data?" → cloud model → on-prem model → the honest trade-off → what you keep (control).
Video suggestion: 30s screen capture of a query answered with no network connection, a "no internet" indicator visible.
...
Carousel suggestion: 5 slayt — "Yapay zekanız verinizi nereye gönderiyor?" → bulut modeli → yerinde model → dürüst ödünleşim → elinizde kalan (kontrol).
Video suggestion: 30 sn ekran kaydı: internet bağlantısı olmadan yanıtlanan bir soru, "internet yok" göstergesi görünür.
...
**EN**
Hook: The AI question just changed from "which model?" to "whose servers?"
Body: For two years the enterprise debate was about capability — which model is smartest. That question is settling. The harder one is now on the table: where does your data go when the AI reads it? For regulated industries and public institutions, data residency isn't a preference, it's a mandate. You can't answer a compliance auditor with "the vendor promises not to look." AdOS was built for this shift. It keeps AI and data on the customer's own infrastructure, offline-capable, fully audited. The wedge is simple — you want AI, but you can't send your knowledge to someone else's cloud. That tension has a resolution.
CTA: Read the Guide
Hashtags: #DataResidency #SovereignAI #Compliance #CISO #EnterpriseAI
Image suggestion: Two-column split — "which model?" fading, "whose servers?" in focus, architectural style.
Carousel suggestion: 6 slides tracing the shift from capability debate to sovereignty debate, ending on AdOS as the resolution.
Video suggestion: 45s talking-head: "The AI question every board is now asking."

**TR**
Hook: Yapay zeka sorusu "hangi model?"den "kimin sunucusu?"na dönüştü.
Body: İki yıldır kurumsal tartışma yetkinlikle ilgiliydi — hangi model daha akıllı. O soru yerine oturuyor. Şimdi masada daha zoru var: yapay zeka verinizi okurken veriniz nereye gidiyor? Regüle sektörler ve kamu kurumları için veri ikametgahı bir tercih değil, bir zorunluluktur. Bir denetçiye "tedarikçi bakmayacağına söz verdi" diyemezsiniz. AdOS tam bu dönüşüm için kuruldu. Yapay zekayı ve veriyi müşterinin kendi altyapısında tutar; çevrimdışı çalışabilir, tam denetlenebilir. Mesele basit — yapay zeka istiyorsunuz ama bilginizi başkasının bulutuna gönderemezsiniz. Bu gerilimin bir çözümü var.
CTA: Rehberi Okuyun
Hashtags: #VeriİkametgahI #SovereignAI #Uyumluluk #CISO #KurumsalYapayZeka
Image suggestion: İki sütunlu ayrım — "hangi model?" soluyor, "kimin sunucusu?" odakta, mimari stil.
Carousel suggestion: 6 slayt: yetkinlik tartışmasından egemenlik tartışmasına geçiş, AdOS çözüm olarak.
Video suggestion: 45 sn konuşan kişi: "Her yönetim kurulunun artık sorduğu yapay zeka sorusu."
...
## Week 2 · Post 4 (Behind the scenes)
...
## Week 2 · Post 5 (Customer story · ILLUSTRATIVE)
...
## Week 2 · Post 6 (Founder perspective)

**EN**
Hook: I got tired of telling customers "just trust the vendor."
Body: For years the answer to "where does our data go?" was a shrug and a promise in a contract. I stopped finding that acceptable. If AI is going to read every document a company owns, the company should own the AI too — the model, the data, the audit trail. That's why AdOS runs entirely on the customer's infrastructure, with no external API and no internet dependency. I won't pretend it's free of trade-offs: local inference is slower than a hosted frontier API. But "slower and yours" beats "instant and gone." Sovereignty is a choice, and I think more leaders are ready to make it.
CTA: Talk to Sales
Hashtags: #FounderPerspective #SovereignAI #DataSovereignty #Leadership #AdOS
Image suggestion: Understated portrait-style graphic with the pull-quote "slower and yours beats instant and gone."
Carousel suggestion: 4 slides — the problem, the shrug, the decision, the trade-off I'll defend.
Video suggestion: 60s founder direct-to-camera on why sovereignty became non-negotiable.

**TR**
Hook: Müşterilere "tedarikçiye güvenin yeter" demekten yoruldum.
Body: Yıllarca "verimiz nereye gidiyor?" sorusunun yanıtı bir omuz silkme ve sözleşmedeki bir vaatti. Bunu kabul edilebilir bulmayı bıraktım. Yapay zeka bir şirketin sahip olduğu her belgeyi okuyacaksa, şirket yapay zekaya da sahip olmalı — modele, veriye, denetim kaydına. AdOS bu yüzden tamamen müşterinin altyapısında çalışır; harici API ve internet bağımlılığı olmadan. Ödünleşimsiz olduğunu iddia etmeyeceğim: yerel çıkarım, barındırılan bir sınır API'sinden yavaştır. Ama "yavaş ama sizin", "anında ama gitmiş"ten iyidir. Egemenlik bir tercihtir ve bence daha çok lider bunu yapmaya hazır.
CTA: Satışla Görüşün
Hashtags: #KurucuBakışı #SovereignAI #VeriEgemenliği #Liderlik #AdOS
Image suggestion: Sade portre tarzı grafik, alıntı: "yavaş ama sizin, anında ama gitmişten iyidir."
Carousel suggestion: 4 slayt — sorun, omuz silkme, karar, savunacağım ödünleşim.
Video suggestion: 60 sn kurucu, kameraya doğrudan: egemenlik neden tartışılmaz oldu.
...
**EN**
Hook: "AI-powered" tells you nothing. Where it runs tells you everything.
Body: A model is only half the story. The other half is the boundary it operates inside. AdOS uses local AI: inference runs on your own hardware through Ollama or any OpenAI-compatible server — vLLM, LM Studio, llama.cpp, SGLang. That means no external API, no API keys, no per-token bill, and no vendor lock-in. You can swap engines because the interface is open, and your data is portable and exportable. The capability lives where your data already lives. Frontier-hosted AI trades control for speed; local AI trades a little speed for total control. Know which trade you're making.
CTA: Read the Guide
Hashtags: #LocalLLM #Ollama #vLLM #NoVendorLockIn #AdOS
Image suggestion: Diagram of interchangeable local engines plugging into AdOS via one OpenAI-compatible interface.
Carousel suggestion: 6 slides — what "local AI" means, the engines supported, no keys, no per-token bill, no lock-in, portable data.
Video suggestion: 40s demo switching the underlying local engine with no change to the app.

**TR**
Hook: "Yapay zeka destekli" hiçbir şey söylemez. Nerede çalıştığı her şeyi söyler.
Body: Model, hikâyenin yalnızca yarısıdır. Diğer yarısı, içinde çalıştığı sınırdır. AdOS yerel yapay zeka kullanır: çıkarım kendi donanımınızda Ollama veya OpenAI uyumlu herhangi bir sunucuda çalışır — vLLM, LM Studio, llama.cpp, SGLang. Yani harici API yok, API anahtarı yok, token başına fatura yok, tedarikçiye bağımlılık yok. Arayüz açık olduğu için motorları değiştirebilirsiniz; veriniz taşınabilir ve dışa aktarılabilir. Yetkinlik, verinizin zaten yaşadığı yerde bulunur. Barındırılan sınır yapay zekası kontrolü hıza değişir; yerel yapay zeka biraz hızı tam kontrole değişir. Hangi takası yaptığınızı bilin.
CTA: Rehberi Okuyun
Hashtags: #LocalLLM #Ollama #vLLM #TedarikçiBağımsızlığı #AdOS
Image suggestion: Tek bir OpenAI uyumlu arayüzle AdOS'a takılan değiştirilebilir yerel motorların diyagramı.
Carousel suggestion: 6 slayt — "yerel yapay zeka" nedir, desteklenen motorlar, anahtar yok, token faturası yok, bağımlılık yok, taşınabilir veri.
Video suggestion: 40 sn demo: uygulamada değişiklik olmadan alttaki yerel motoru değiştirme.

---

## Week 3 · Post 8 (Knowledge)
...
Carousel suggestion: 5 slayt — bilgi nerede saklanır, neden gider, maliyeti, Company Brain, alıntılı erişim.
Video suggestion: 45 sn açıklayıcı animasyon: örtük bilginin aranabilir, alıntılı bir Company Brain'e dönüşmesi.

---

## Week 3 · Post 9 (Enterprise)
...
**TR**
Hook: Verileriniz için en güvenli yer, zaten kontrol ettiğiniz yerdir.
Body: Güvenlik ekipleri modeller yüzünden uykusuz kalmaz. Verinin dışarı çıkması yüzünden kalır. AdOS bu çıkışı tamamen kaldırır: müşteri verisi — belgeler, istemler, yanıtlar, iş akışları — binadan asla çıkmaz ve iş içeriğine dair telemetri yoktur. Yerinde veya özel bulutunuzda kurulur; çevrimdışı öncelikli ve hava boşluğu (air-gap) uyumludur. Yapay zeka yetki farkındalıklıdır; model, bir kullanıcının görmeye yetkili olmadığı içeriği asla açığa çıkaramaz veya alıntılayamaz. Her önemli eylem değiştirilemez bir denetim kaydına düşer. Çok kiracılı izolasyon katıdır. Bir CISO için mesaj kısa: aktarımda ele geçirilecek bir şey yok, çünkü hiçbir şey bir yere gitmiyor.
CTA: Satışla Görüşün
...
## Week 4 · Post 11 (Educational)

**EN**
Hook: "On-premise AI" sounds hard. Here's what deployment actually looks like.
Body: The fear is that sovereign AI means a six-month integration project. It doesn't have to. AdOS ships as standard Docker with a one-command bring-up, plus documented runbooks for backup, restore, upgrade, and disaster recovery. It's version 1.0.0 — a real, shippable product, not a science project. It's multi-tenant with strict isolation and bilingual out of the box, Turkish and English, auto-detected from the environment. The honest part: you provide the hardware, and better hardware means faster answers. But "deploy it on infrastructure you own" is an operational task your IT team already knows how to do — not a leap of faith.
CTA: Read the Guide
Hashtags: #DevOps #Docker #OnPremAI #ITLeadership #AdOS
Image suggestion: Terminal window showing a single bring-up command, calm dark theme.
Carousel suggestion: 5 slides — Docker bring-up, runbooks, multi-tenant, bilingual, the hardware trade-off.
Video suggestion: 45s time-lapse of a one-command deploy reaching a working login screen.

**TR**
Hook: "Yerinde yapay zeka" kulağa zor geliyor. Kurulum gerçekte nasıl görünüyor?
Body: Korku, egemen yapay zekanın altı aylık bir entegrasyon projesi anlamına gelmesi. Öyle olmak zorunda değil. AdOS, tek komutla ayağa kalkan standart Docker olarak gelir; ayrıca yedekleme, geri yükleme, yükseltme ve felaket kurtarma için belgelenmiş runbook'larla. Sürüm 1.0.0 — gerçek, sevk edilebilir bir ürün, bir deney değil. Katı izolasyonla çok kiracılı ve kutudan çıktığı gibi iki dilli: Türkçe ve İngilizce, ortamdan otomatik algılanır. Dürüst kısmı: donanımı siz sağlarsınız ve daha iyi donanım daha hızlı yanıt demektir. Ama "sahip olduğunuz altyapıya kurun" IT ekibinizin zaten bildiği operasyonel bir iştir — bir inanç sıçraması değil.
CTA: Rehberi Okuyun
Hashtags: #DevOps #Docker #OnPremAI #ITLiderliği #AdOS
Image suggestion: Tek bir ayağa kaldırma komutunu gösteren terminal penceresi, sakin koyu tema.
Carousel suggestion: 5 slayt — Docker ile ayağa kaldırma, runbook'lar, çok kiracılı, iki dilli, donanım ödünleşimi.
Video suggestion: 45 sn hızlandırılmış: tek komutla kurulumun çalışan bir giriş ekranına ulaşması.

---

## Week 4 · Post 12 (Industry insight)

**EN**
Hook: Per-token billing is a meter running on your curiosity.
Body: Hosted AI charges by the token. Every question your team asks adds to a bill that grows with adoption — the more useful it gets, the more it costs to use. That model quietly discourages the exact behavior you want. AdOS has no per-token billing. Inference runs on your own hardware, so the marginal cost of a query is your electricity, not a vendor's meter. Pricing is value-based: a platform license plus support, per deployment or per-seat band — never per query. The strategic effect is real: when asking costs nothing extra, people ask more, and the Company Brain gets used the way it should be.
CTA: Calculate Your ROI
Hashtags: #TCO #CFO #EnterpriseAI #Pricing #AdOS
Image suggestion: A taxi meter crossed out beside a flat-rate license icon.
Carousel suggestion: 5 slides — how per-token adds up, the adoption penalty, no metering, value-based license, ask freely.
Video suggestion: 40s explainer contrasting a climbing token meter with a flat local-cost line.

**TR**
Hook: Token başına faturalama, merakınızın üzerinde çalışan bir sayaçtır.
Body: Barındırılan yapay zeka token başına ücret alır. Ekibinizin sorduğu her soru, benimsemeyle büyüyen bir faturaya eklenir — ne kadar faydalı olursa, kullanması o kadar pahalıya gelir. Bu model, tam da istediğiniz davranışı sessizce caydırır. AdOS'ta token başına faturalama yoktur. Çıkarım kendi donanımınızda çalışır; bir sorgunun marjinal maliyeti bir tedarikçinin sayacı değil, elektriğinizdir. Fiyatlandırma değere dayalıdır: platform lisansı artı destek, dağıtım başına veya koltuk bandı başına — asla sorgu başına değil. Stratejik etki gerçek: sormak fazladan bir şeye mal olmadığında insanlar daha çok sorar ve Company Brain olması gerektiği gibi kullanılır.
CTA: ROI'nizi Hesaplayın
Hashtags: #TCO #CFO #KurumsalYapayZeka #Fiyatlandırma #AdOS
Image suggestion: Üzeri çizili bir taksimetre yanında sabit ücretli lisans ikonu.
Carousel suggestion: 5 slayt — token başına nasıl birikir, benimseme cezası, sayaç yok, değere dayalı lisans, özgürce sor.
Video suggestion: 40 sn açıklayıcı: yükselen token sayacı ile sabit yerel maliyet çizgisinin karşılaştırması.
...
## Week 5 · Post 14 (Behind the scenes)

**EN**
Hook: We wrote disaster recovery runbooks before we wrote a launch tweet.
Body: Priorities show up in what you build first. Before the marketing, we shipped the unglamorous parts: documented backup, restore, upgrade, and disaster-recovery runbooks for AdOS 1.0.0. Because sovereignty means you own the whole stack — app, data, and model — and owning it means you need to operate it on a bad day, not just a good one. On-premise software that can't be recovered isn't sovereignty, it's risk. So day-2 operations were a design requirement, not an afterthought. If we're asking IT teams to run AdOS on their own hardware, we owe them the runbooks to do it with confidence.
CTA: Talk to Sales
Hashtags: #DisasterRecovery #DevOps #Reliability #ITOps #AdOS
Image suggestion: A tidy shelf of labeled runbooks — Backup, Restore, Upgrade, DR — vector style.
Carousel suggestion: 4 slides — why day-2 first, the four runbooks, what ownership demands, our commitment.
Video suggestion: 45s screen tour of a documented restore procedure being followed step by step.

**TR**
Hook: Bir lansman tweeti yazmadan önce felaket kurtarma runbook'ları yazdık.
Body: Öncelikler ilk neyi kurduğunuzda görünür. Pazarlamadan önce göz alıcı olmayan kısımları sevk ettik: AdOS 1.0.0 için belgelenmiş yedekleme, geri yükleme, yükseltme ve felaket kurtarma runbook'ları. Çünkü egemenlik tüm yığına sahip olmak demektir — uygulama, veri ve model — ve sahip olmak, onu iyi bir günde değil kötü bir günde de işletmeniz gerektiği anlamına gelir. Kurtarılamayan yerinde yazılım egemenlik değil, risktir. Bu yüzden day-2 operasyonları sonradan akla gelen değil, bir tasarım gereğiydi. IT ekiplerinden AdOS'u kendi donanımlarında çalıştırmalarını istiyorsak, bunu güvenle yapacakları runbook'ları onlara borçluyuz.
CTA: Satışla Görüşün
Hashtags: #FelaketKurtarma #DevOps #Güvenilirlik #ITOps #AdOS
Image suggestion: Etiketli runbook'ların düzenli rafı — Yedekleme, Geri Yükleme, Yükseltme, DR — vektör tarzı.
Carousel suggestion: 4 slayt — neden önce day-2, dört runbook, sahipliğin gerektirdiği, taahhüdümüz.
Video suggestion: 45 sn ekran turu: belgelenmiş bir geri yükleme prosedürünün adım adım uygulanması.

---

## Week 5 · Post 15 (Customer story · ILLUSTRATIVE)
...
## Week 6 · Post 16 (Founder perspective)

**EN**
Hook: I'd rather concede a trade-off than sell you a miracle.
Body: Here's something most AI pitches won't say: local CPU inference is slower than a hosted frontier API. Seconds, not milliseconds. Better hardware narrows that gap, but I won't pretend it vanishes. I lead with this because trust is the whole product. If I hide the trade-off, you'll find it in week one and stop believing anything else I told you. So I'll say it plainly: you give up a little speed and you get complete sovereignty — your data never leaves the building, no per-token bill, no lock-in. That's the deal. I think for most serious institutions, it's the right one.
CTA: Talk to Sales
Hashtags: #FounderPerspective #HonestMarketing #SovereignAI #Trust #AdOS
Image suggestion: Balance-scale graphic: "a little speed" on one side, "total sovereignty" on the other.
Carousel suggestion: 4 slides — the thing pitches hide, why I say it, the actual deal, who it's right for.
Video suggestion: 60s founder to camera stating the speed trade-off before anything else.

**TR**
Hook: Size bir mucize satmaktansa bir ödünleşimi kabul etmeyi tercih ederim.
Body: Çoğu yapay zeka sunumunun söylemeyeceği bir şey var: yerel CPU çıkarımı, barındırılan bir sınır API'sinden yavaştır. Milisaniye değil, saniye. Daha iyi donanım bu farkı daraltır ama yok olduğunu iddia etmeyeceğim. Bununla başlıyorum çünkü ürünün tamamı güvendir. Ödünleşimi saklarsam, ilk hafta bulursunuz ve size söylediğim başka hiçbir şeye inanmazsınız. O yüzden açıkça söyleyeyim: biraz hızdan vazgeçer, tam egemenlik kazanırsınız — veriniz binadan asla çıkmaz, token başına fatura yok, bağımlılık yok. Anlaşma bu. Çoğu ciddi kurum için doğru olanın bu olduğunu düşünüyorum.
CTA: Satışla Görüşün
Hashtags: #KurucuBakışı #DürüstPazarlama #SovereignAI #Güven #AdOS
Image suggestion: Terazi grafiği: bir yanda "biraz hız", diğer yanda "tam egemenlik".
Carousel suggestion: 4 slayt — sunumların sakladığı şey, neden söylüyorum, gerçek anlaşma, kime uygun.
Video suggestion: 60 sn kurucu, kameraya: her şeyden önce hız ödünleşimini söylüyor.
...
Carousel suggestion: 5 slayt — parçalanmış saha bilgisi, maliyeti, tek Company Brain, yetki kapsamlama, paylaşılan ama sızmayan.
Video suggestion: 45 sn animasyon: birden çok sahadan içgörülerin tek bir alıntılı yanıta yakınsaması.

---

## Week 7 · Post 19 (Enterprise)
...
Carousel suggestion: 8 slides — one per committee role and the AdOS answer it cares about.
Video suggestion: 60s explainer mapping each stakeholder's question to an AdOS capability.

**TR**
Hook: Egemen yapay zekanın satın alma komitesinde sekiz koltuk var. Hepsi için kurduk.
Body: Kurumsal yapay zeka asla tek kişinin kararı değildir. CEO strateji ve ROI ister. CIO TCO ve desteklenebilirliği tartar. CTO mimariyi ve model seçimini inceler. CISO veri sızıntısını ve denetimi sorar. İK benimsemeyi ve bilgi sürekliliğini önemser. Operasyon daha hızlı onay ister. IT/BT day-2'ye sahiptir. Finans maliyeti izler. AdOS her birine yanıt verir: mimari gereği egemen, güvenlik için alıntılı ve yetki farkındalıklı, finans için token sayacı olmayan değere dayalı fiyatlandırma, IT için runbook'lu Docker kurulumu, İK için bilgi sürekliliği. Tek platform, tek gerçek, evet demek için sekiz ayrı neden. Egemenlik, tüm komitenin içinde durabileceği çerçevedir.
CTA: Demo Talep Edin
Hashtags: #KurumsalYapayZeka #SatınAlmaKomitesi #CIO #CISO #AdOS
Image suggestion: Sekiz etiketli koltuklu yuvarlak masa, her biri bir AdOS değerine bağlı.
Carousel suggestion: 8 slayt — her komite rolü ve önemsediği AdOS yanıtı.
Video suggestion: 60 sn açıklayıcı: her paydaşın sorusunu bir AdOS yeteneğine eşleme.
...
## Week 7 · Post 21 (Educational)

**EN**
Hook: Air-gapped isn't paranoid. For some institutions, it's the only legal option.
Body: An air-gapped system has no connection to any outside network — nothing can reach in, nothing can leak out. For defense-adjacent manufacturers, hospitals, and public institutions under residency mandates, that's not caution, it's the requirement. Most enterprise AI simply can't operate there because it depends on a call to someone else's cloud. AdOS is offline-first and air-gap capable: inference runs locally, no external API, no internet required. You can literally unplug the network and keep asking the Company Brain questions. If your compliance posture rules out the cloud, it doesn't have to rule out AI. Sovereignty and capability aren't opposites.
CTA: Read the Guide
Hashtags: #AirGap #OfflineAI #Compliance #PublicSector #AdOS
Image suggestion: A building with a visibly severed network cable, still fully operational inside.
Carousel suggestion: 5 slides — what air-gap means, who needs it, why cloud AI fails there, AdOS offline-first, unplug and keep working.
Video suggestion: 30s "unplug the cable" demo of the Company Brain still answering offline.

**TR**
Hook: Hava boşluğu (air-gap) paranoya değil. Bazı kurumlar için tek yasal seçenek.
Body: Hava boşluklu bir sistemin dış ağla bağlantısı yoktur — içeri hiçbir şey ulaşamaz, dışarı hiçbir şey sızamaz. Savunmaya yakın üreticiler, hastaneler ve ikametgah zorunluluğu altındaki kamu kurumları için bu bir tedbir değil, bir gerekliliktir. Çoğu kurumsal yapay zeka orada çalışamaz bile, çünkü başkasının bulutuna yapılan bir çağrıya bağımlıdır. AdOS çevrimdışı önceliklidir ve air-gap uyumludur: çıkarım yerel çalışır, harici API yok, internet gerekmez. Ağı gerçekten çıkarıp Company Brain'e soru sormaya devam edebilirsiniz. Uyumluluk duruşunuz bulutu dışlıyorsa, yapay zekayı dışlamak zorunda değildir. Egemenlik ve yetkinlik zıt değildir.
CTA: Rehberi Okuyun
Hashtags: #AirGap #ÇevrimdışıYapayZeka #Uyumluluk #KamuSektörü #AdOS
Image suggestion: Ağ kablosu görünür şekilde kesilmiş, içeride tamamen çalışan bir bina.
Carousel suggestion: 5 slayt — air-gap nedir, kime gerekir, bulut yapay zeka orada neden başarısız olur, AdOS çevrimdışı öncelikli, çıkar ve çalışmaya devam et.
Video suggestion: 30 sn "kabloyu çıkar" demosu: Company Brain hâlâ çevrimdışı yanıt veriyor.

---

## Week 8 · Post 22 (Industry insight)

**EN**
Hook: Turkey's AI adoption has a bottleneck, and it isn't talent.
Body: Turkish enterprises and public institutions want AI. The bottleneck is data residency — moving sensitive institutional data to a foreign cloud is often a non-starter, legally or politically. That gap is exactly where sovereign AI belongs. AdOS was built Turkey-first: full Turkish and English UI, auto-detected from the environment, with both languages carrying identical claims and numbers. It runs on the customer's own infrastructure, so residency stops being an obstacle and becomes a default. This isn't a translated foreign product; it's on-prem AI designed for markets where keeping data at home is the baseline. Local capability, local data, local language.
CTA: See the Platform
Hashtags: #TurkeyTech #SovereignAI #DataResidency #YapayZeka #AdOS
Image suggestion: Map motif of Turkey with data staying inside national/organizational boundaries.
Carousel suggestion: 5 slides — the residency bottleneck, why cloud stalls, Turkey-first design, bilingual parity, on-prem as default.
Video suggestion: 45s bilingual explainer toggling TR/EN UI on the same screens.

**TR**
Hook: Türkiye'nin yapay zeka benimsemesinde bir darboğaz var ve bu yetenek değil.
Body: Türk kurumları ve kamu kuruluşları yapay zeka istiyor. Darboğaz veri ikametgahı — hassas kurumsal veriyi yabancı bir buluta taşımak çoğu zaman yasal ya da politik olarak imkânsız. Bu boşluk tam olarak egemen yapay zekanın yeridir. AdOS Türkiye öncelikli kuruldu: ortamdan otomatik algılanan tam Türkçe ve İngilizce arayüz; her iki dil de aynı iddiaları ve sayıları taşır. Müşterinin kendi altyapısında çalışır; böylece ikametgah bir engel olmaktan çıkıp bir varsayılan hâline gelir. Bu çevrilmiş yabancı bir ürün değil; verinin evde kalmasının temel olduğu pazarlar için tasarlanmış yerinde yapay zekadır. Yerel yetenek, yerel veri, yerel dil.
CTA: Platformu Keşfedin
Hashtags: #TürkiyeTeknoloji #SovereignAI #VeriİkametgahI #YapayZeka #AdOS
Image suggestion: Verinin ulusal/kurumsal sınırlar içinde kaldığı Türkiye harita motifi.
Carousel suggestion: 5 slayt — ikametgah darboğazı, bulut neden tıkanır, Türkiye öncelikli tasarım, iki dilli eşitlik, varsayılan olarak yerinde.
Video suggestion: 45 sn iki dilli açıklayıcı: aynı ekranlarda TR/EN arayüz geçişi.

---

## Week 8 · Post 23 (Product)
...
## Week 8 · Post 24 (Behind the scenes)

**EN**
Hook: We keep every claim honest with one boring rule.
Body: Every sentence in our marketing has to trace back to a single source of truth — a canonical brief shared with our sales team. No adjective survives that can't be backed by a fact. That's why you'll never see us claim a certification we don't hold, a customer we don't have, or a metric we can't stand behind. Our case studies say "illustrative" out loud, because inventing a happy customer would be lying. It's an unglamorous discipline, and it occasionally makes the copy less flashy. Good. In sovereign AI, the buyer is a skeptical expert. The fastest way to lose them is one claim that doesn't hold.
CTA: Read the Guide
Hashtags: #HonestMarketing #BrandTrust #B2BMarketing #Governance #AdOS
Image suggestion: A single "source of truth" document with claim-arrows tracing back to it.
Carousel suggestion: 5 slides — the rule, no fake certs, no fake customers, labeled illustrative, why skeptics reward it.
Video suggestion: 40s behind-the-scenes of a claim being checked against the canonical brief before publish.

**TR**
Hook: Her iddiayı sıkıcı bir kuralla dürüst tutuyoruz.
Body: Pazarlamamızdaki her cümle tek bir doğruluk kaynağına dayanmak zorunda — satış ekibimizle paylaşılan kanonik bir brif. Bir gerçekle desteklenemeyen hiçbir sıfat hayatta kalmaz. Bu yüzden sahip olmadığımız bir sertifikayı, sahip olmadığımız bir müşteriyi ya da arkasında duramayacağımız bir metriği asla iddia ettiğimizi görmezsiniz. Vaka çalışmalarımız açıkça "illüstratif" der, çünkü mutlu bir müşteri uydurmak yalan olurdu. Göz alıcı olmayan bir disiplin ve zaman zaman metni daha az cafcaflı yapıyor. İyi. Egemen yapay zekada alıcı şüpheci bir uzmandır. Onu kaybetmenin en hızlı yolu, tutmayan tek bir iddiadır.
CTA: Rehberi Okuyun
Hashtags: #DürüstPazarlama #MarkaGüveni #B2BPazarlama #Yönetişim #AdOS
Image suggestion: Tek bir "doğruluk kaynağı" belgesi, iddia-okları ona geri işaret ediyor.
Carousel suggestion: 5 slayt — kural, sahte sertifika yok, sahte müşteri yok, illüstratif etiketli, şüpheciler neden ödüllendirir.
Video suggestion: 40 sn perde arkası: bir iddianın yayından önce kanonik brife karşı kontrol edilmesi.

---

## Week 9 · Post 25 (Customer story · ILLUSTRATIVE)
...
## Week 9 · Post 26 (Founder perspective)

**EN**
Hook: We chose to own the hard parts instead of renting the easy ones.
Body: The easy path in AI is to wrap someone else's hosted API and ship in a weekend. We didn't. We built AdOS on local engines — Ollama and any OpenAI-compatible server — so the customer owns the whole stack: app, data, and model. That's harder. It means supporting real deployment, real backup and disaster recovery, real hardware trade-offs. But renting the easy part means handing your customer's data to a third party and calling it a feature. I couldn't square that with the promise we make. If sovereignty is the point, you can't outsource the core of it. So we didn't.
CTA: Talk to Sales
Hashtags: #FounderPerspective #NoVendorLockIn #SovereignAI #BuildVsBuy #AdOS
Image suggestion: Two forks in a road — "rent the API" vs "own the stack" — the second one taken.
Carousel suggestion: 4 slides — the easy path, why we refused it, what owning the stack costs, why it's worth it.
Video suggestion: 60s founder to camera on choosing ownership over the quick wrapper.

**TR**
Hook: Kolay olanı kiralamak yerine zor kısımlara sahip olmayı seçtik.
Body: Yapay zekada kolay yol, başkasının barındırılan API'sini sarıp bir hafta sonunda sevk etmektir. Biz yapmadık. AdOS'u yerel motorlar üzerine kurduk — Ollama ve OpenAI uyumlu herhangi bir sunucu — böylece müşteri tüm yığına sahip: uygulama, veri ve model. Bu daha zor. Gerçek kurulumu, gerçek yedekleme ve felaket kurtarmayı, gerçek donanım ödünleşimlerini desteklemek demek. Ama kolay kısmı kiralamak, müşterinizin verisini üçüncü bir tarafa vermek ve buna özellik demektir. Bunu verdiğimiz sözle bağdaştıramadım. Mesele egemenlikse, çekirdeğini dışarıya veremezsiniz. Biz de vermedik.
CTA: Satışla Görüşün
Hashtags: #KurucuBakışı #TedarikçiBağımsızlığı #SovereignAI #YapVsSatınAl #AdOS
Image suggestion: Yolda iki ayrım — "API kirala" vs "yığına sahip ol" — ikincisi seçilmiş.
Carousel suggestion: 4 slayt — kolay yol, neden reddettik, yığına sahip olmanın maliyeti, neden değer.
Video suggestion: 60 sn kurucu, kameraya: hızlı sarmalayıcı yerine sahipliği seçmek.
...
**EN**
Hook: You shouldn't have to marry a model to use AI.
Body: Hosted AI usually locks you to one provider's model, one API, one pricing meter. Switching later is a migration project. AdOS avoids the trap by design: it speaks an open, OpenAI-compatible interface to local engines, so you can run vLLM today and swap to another engine tomorrow without rewriting the application. Your data is portable and exportable — it's yours to move. No API keys, no per-token bill, no vendor lock-in. That's not just a cost point; it's resilience. When your AI capability isn't hostage to one vendor's roadmap or price changes, you keep the leverage. Own the model choice, don't rent your dependence.
CTA: Read the Guide
Hashtags: #NoVendorLockIn #LocalLLM #OpenStandards #vLLM #AdOS
Image suggestion: A model slot with interchangeable engine cards sliding in and out through one open port.
Carousel suggestion: 5 slides — the lock-in trap, open interface, swappable engines, portable data, resilience.
Video suggestion: 40s demo swapping the local engine with zero application changes.

**TR**
Hook: Yapay zeka kullanmak için bir modelle evlenmek zorunda olmamalısınız.
Body: Barındırılan yapay zeka genellikle sizi tek bir sağlayıcının modeline, tek bir API'ye, tek bir fiyat sayacına kilitler. Sonradan geçiş yapmak bir taşıma projesidir. AdOS bu tuzaktan tasarım gereği kaçınır: yerel motorlara açık, OpenAI uyumlu bir arayüzle konuşur; böylece bugün vLLM çalıştırıp yarın uygulamayı yeniden yazmadan başka bir motora geçebilirsiniz. Veriniz taşınabilir ve dışa aktarılabilir — taşımak sizin elinizde. API anahtarı yok, token başına fatura yok, tedarikçi bağımlılığı yok. Bu yalnızca bir maliyet noktası değil; dayanıklılıktır. Yapay zeka yeteneğiniz tek bir tedarikçinin yol haritasına ya da fiyat değişikliklerine rehin olmadığında, kaldıraç sizde kalır. Model seçimine sahip olun, bağımlılığınızı kiralamayın.
CTA: Rehberi Okuyun
Hashtags: #TedarikçiBağımsızlığı #LocalLLM #AçıkStandartlar #vLLM #AdOS
Image suggestion: Tek bir açık porttan girip çıkan değiştirilebilir motor kartlarıyla bir model yuvası.
Carousel suggestion: 5 slayt — kilit tuzağı, açık arayüz, değiştirilebilir motorlar, taşınabilir veri, dayanıklılık.
Video suggestion: 40 sn demo: sıfır uygulama değişikliğiyle yerel motoru değiştirme.

---

## Week 10 · Post 28 (Knowledge)
...
Carousel suggestion: 5 slayt — arama vs yanıt, manuel sentez vergisi, temellendirilmiş yanıtlar, alıntılar, yetki farkındalıklı.
Video suggestion: 40 sn yan yana: anahtar kelime arama sonuçları vs tek bir alıntılı Company Brain yanıtı.

---

## Week 10 · Post 29 (Enterprise)

**EN**
Hook: You already own your buildings. Why rent your intelligence?
Body: Enterprises own their factories, their servers, their filing cabinets. Then they're told the AI layer — the thing reading all of it — has to be rented from someone else's cloud, metered by the token, hosted off-site. AdOS rejects that asymmetry. It's an enterprise AI operating system you fully own: the app, the data, and the model, all on infrastructure you control. No per-token bill, no vendor lock-in, no data leaving the premises. Ownership isn't nostalgia; it's how you keep cost predictable, compliance clean, and leverage on your side. If intelligence is becoming core infrastructure, treat it like infrastructure you own.
CTA: Calculate Your ROI
Hashtags: #EnterpriseAI #Ownership #TCO #DataSovereignty #AdOS
Image suggestion: An owned building with an "intelligence" layer drawn inside it, not rented from a cloud.
Carousel suggestion: 5 slides — what you own, what you're told to rent, the asymmetry, full ownership, predictable cost.
Video suggestion: 45s explainer contrasting rented cloud intelligence with owned on-prem AdOS.

**TR**
Hook: Binalarınıza zaten sahipsiniz. Zekanızı neden kiralıyorsunuz?
Body: Kurumlar fabrikalarına, sunucularına, dosya dolaplarına sahiptir. Sonra onlara yapay zeka katmanının — tüm bunları okuyan şeyin — başkasının bulutundan kiralanması, token başına ölçülmesi, dışarıda barındırılması gerektiği söylenir. AdOS bu asimetriyi reddeder. Tamamen sahip olduğunuz bir kurumsal yapay zeka işletim sistemidir: uygulama, veri ve model, hepsi kontrol ettiğiniz altyapıda. Token başına fatura yok, tedarikçi bağımlılığı yok, veriler binadan çıkmıyor. Sahiplik nostalji değil; maliyeti öngörülebilir, uyumluluğu temiz ve kaldıracı sizin tarafınızda tutma yöntemidir. Zeka çekirdek altyapı hâline geliyorsa, ona sahip olduğunuz bir altyapı gibi davranın.
CTA: ROI'nizi Hesaplayın
Hashtags: #KurumsalYapayZeka #Sahiplik #TCO #VeriEgemenliği #AdOS
Image suggestion: İçine "zeka" katmanı çizilmiş, buluttan kiralanmayan, sahip olunan bir bina.
Carousel suggestion: 5 slayt — neye sahipsiniz, neyi kiralamanız söyleniyor, asimetri, tam sahiplik, öngörülebilir maliyet.
Video suggestion: 45 sn açıklayıcı: kiralanan bulut zekası ile sahip olunan yerinde AdOS karşılaştırması.

---

## Week 10 · Post 30 (Security)
...
Carousel suggestion: 5 slides — the joke, the serious edge, when cloud is fine, when it's disqualifying, deciding deliberately.
Video suggestion: 45s explainer contrasting where a query is processed in cloud vs on-prem.
...
Carousel suggestion: 5 slayt — şaka, ciddi yanı, bulut ne zaman uygun, ne zaman eleyici, bilinçli karar.
Video suggestion: 45 sn açıklayıcı: bir sorgunun bulutta vs yerinde nerede işlendiği karşılaştırması.

---

## Week 11 · Post 32 (Industry insight)
...
Carousel suggestion: 5 slides — point-tool wave, its ceiling, the OS wave, one platform/one permission model, the new question.
Video suggestion: 50s explainer animating fragmented tools consolidating into one AdOS platform.
...
Carousel suggestion: 5 slayt — nokta araç dalgası, tavanı, OS dalgası, tek platform/tek yetki modeli, yeni soru.
Video suggestion: 50 sn açıklayıcı: parçalı araçların tek bir AdOS platformunda birleşmesi.

---

## Week 11 · Post 33 (Product)

**EN**
Hook: One command up. Documented runbooks for the bad days.
Body: Sovereign AI shouldn't mean operational guesswork. AdOS deploys as standard Docker with a one-command bring-up, so getting to a running system is a known procedure, not a bespoke project. And because you own the stack, we ship the day-2 essentials: documented runbooks for backup, restore, upgrade, and disaster recovery. Version 1.0.0 is a real release with strict multi-tenant isolation and bilingual TR/EN built in. Owning your AI only works if you can operate it confidently — on the good days and the bad ones. That's why the boring operational documentation ships alongside the product, not months later. Deployment you can predict, recovery you can rehearse.
CTA: See the Platform
Hashtags: #DevOps #Docker #DisasterRecovery #OnPremAI #AdOS
Image suggestion: Split image — one-command terminal on the left, labeled runbook set on the right.
Carousel suggestion: 5 slides — Docker bring-up, the four runbooks, multi-tenant, bilingual, own it and operate it.
Video suggestion: 50s walkthrough from bring-up command to a documented backup being run.

**TR**
Hook: Tek komutla ayağa. Kötü günler için belgelenmiş runbook'lar.
Body: Egemen yapay zeka operasyonel tahmin oyunu anlamına gelmemeli. AdOS tek komutla ayağa kalkan standart Docker olarak kurulur; yani çalışan bir sisteme ulaşmak özel bir proje değil, bilinen bir prosedürdür. Yığına sahip olduğunuz için day-2 temellerini de sunuyoruz: yedekleme, geri yükleme, yükseltme ve felaket kurtarma için belgelenmiş runbook'lar. Sürüm 1.0.0, katı çok kiracılı izolasyon ve yerleşik iki dilli TR/EN ile gerçek bir sürümdür. Yapay zekanıza sahip olmak ancak onu güvenle işletebilirseniz işe yarar — iyi günlerde de kötü günlerde de. Bu yüzden sıkıcı operasyonel dokümantasyon aylar sonra değil, ürünle birlikte gelir. Öngörebileceğiniz kurulum, prova edebileceğiniz kurtarma.
CTA: Platformu Keşfedin
Hashtags: #DevOps #Docker #FelaketKurtarma #OnPremAI #AdOS
Image suggestion: İkiye bölünmüş görsel — solda tek komutlu terminal, sağda etiketli runbook seti.
Carousel suggestion: 5 slayt — Docker ile ayağa kaldırma, dört runbook, çok kiracılı, iki dilli, sahip ol ve işlet.
Video suggestion: 50 sn tur: ayağa kaldırma komutundan belgelenmiş bir yedeklemenin çalıştırılmasına.

---

## Week 12 · Post 34 (Behind the scenes)
...
Carousel suggestion: 5 slides — bilingual by default, the parity rule, native review both sides, product names stay English, why it's slower and worth it.
Video suggestion: 40s screen tour toggling the same UI between Turkish and English.
...
Carousel suggestion: 5 slayt — varsayılan iki dilli, eşitlik kuralı, iki tarafta anadil kontrolü, ürün adları İngilizce kalır, neden yavaş ama değerli.
Video suggestion: 40 sn ekran turu: aynı arayüzü Türkçe ve İngilizce arasında geçirme.

---

## Week 12 · Post 35 (Customer story · ILLUSTRATIVE)
...
Carousel suggestion: 5 slides — the audit ask, the old dig, the immutable trail, minutes not days, accountability built in. Watermarked illustrative.
Video suggestion: 45s dramatized demo (fictional) reconstructing an approval path from the audit trail.
...
Carousel suggestion: 5 slayt — denetim talebi, eski eşeleme, değiştirilemez kayıt, günler değil dakikalar, yerleşik hesap verebilirlik. İllüstratif filigranlı.
Video suggestion: 45 sn canlandırılmış demo (kurgusal): denetim kaydından bir onay yolunun yeniden kurulması.

---

## Week 12 · Post 36 (Founder perspective)

**EN**
Hook: We're not trying to build the best cloud assistant. We're building its opposite.
Body: Some markets are already crowded with brilliant hosted AI. We're not competing there. AdOS exists for the organizations that have to say no to all of it — because their data can't legally or safely leave the building. That's not a niche; it's manufacturing, healthcare, finance, public institutions, whole industries told "adopt AI" and "don't move your data" in the same breath. We resolve that contradiction by putting the entire system on their infrastructure. I'd rather be the definitive answer for the buyers who can't use the cloud than a runner-up for the ones who can. Sovereignty isn't our feature. It's our whole reason to exist.
CTA: Talk to Sales
Hashtags: #FounderPerspective #SovereignAI #Category #OnPremAI #AdOS
Image suggestion: A mirror image motif — cloud assistant on one side, its on-prem opposite on the other.
Carousel suggestion: 4 slides — who we don't compete with, who we exist for, the contradiction we resolve, our reason to exist.
Video suggestion: 60s founder to camera on building the opposite of a cloud assistant.

**TR**
Hook: En iyi bulut asistanını kurmaya çalışmıyoruz. Onun tam tersini kuruyoruz.
Body: Bazı pazarlar zaten harika barındırılan yapay zekalarla dolu. Biz orada rekabet etmiyoruz. AdOS, tüm bunlara hayır demek zorunda olan kurumlar için var — çünkü verileri yasal ya da güvenli biçimde binadan çıkamaz. Bu bir niş değil; üretim, sağlık, finans, kamu kurumları; aynı nefeste "yapay zekayı benimseyin" ve "verinizi taşımayın" denen koca sektörler. Bu çelişkiyi tüm sistemi onların altyapısına koyarak çözüyoruz. Bulutu kullanabilenler için ikinci olmaktansa, bulutu kullanamayan alıcılar için kesin yanıt olmayı tercih ederim. Egemenlik bizim özelliğimiz değil. Var olma nedenimizin tamamı.
CTA: Satışla Görüşün
Hashtags: #KurucuBakışı #SovereignAI #Kategori #OnPremAI #AdOS
Image suggestion: Ayna görüntüsü motifi — bir yanda bulut asistanı, diğer yanda yerinde tersi.
Carousel suggestion: 4 slayt — kiminle rekabet etmiyoruz, kimin için varız, çözdüğümüz çelişki, var olma nedenimiz.
Video suggestion: 60 sn kurucu, kameraya: bir bulut asistanının tam tersini kurmak.
...
Carousel suggestion: 5 slides — the speed pitch, the hidden cost, the second axis, the honest trade-off, choose for your risk.
Video suggestion: 40s explainer contrasting a millisecond cloud answer that leaves vs a few-second local answer that stays.
...
Carousel suggestion: 5 slayt — hız sunumu, gizli maliyet, ikinci eksen, dürüst ödünleşim, riskin için seç.
Video suggestion: 40 sn açıklayıcı: dışarı çıkan milisaniyelik bulut yanıtı vs içeride kalan birkaç saniyelik yerel yanıt.

---

## Week 13 · Post 38 (Knowledge)
...
Carousel suggestion: 5 slayt — bilgi sorunu değil, erişim boşluğu, yanıtlanabilir belgeler, alıntılı ve kapsamlı, zaten yazdığını kullan.
Video suggestion: 40 sn demo: mevcut gömülü bir politika belgesinin anında alıntılı bir yanıta dönüşmesi.

---

## Week 13 · Post 39 (Security)

**EN**
Hook: The most secure integration is the one you never have to make.
Body: Every connection to an outside service is a new door — a new credential to rotate, a new party to trust, a new place for data to leak. AdOS reduces that surface to nearly zero by design. It needs no external API, no API keys, no internet connection to function. Inference runs locally; business content generates no telemetry; nothing phones home. It's offline-first and air-gap capable, so it can run in environments where an outbound connection simply isn't allowed. For a security team, fewer doors means fewer things to defend. The strongest posture isn't a better lock on the exit — it's not having an exit at all.
CTA: Talk to Sales
Hashtags: #DataSecurity #AirGap #ZeroTrust #CISO #AdOS
Image suggestion: A building with all outbound doors sealed, one calm interior light on.
Carousel suggestion: 5 slides — every connection is a door, the attack surface, no external API/keys/internet, no telemetry, fewer doors to defend.
Video suggestion: 30s demo confirming zero outbound network calls while the system operates.

**TR**
Hook: En güvenli entegrasyon, hiç yapmak zorunda kalmadığınızdır.
Body: Dış bir servise yapılan her bağlantı yeni bir kapıdır — döndürülecek yeni bir kimlik bilgisi, güvenilecek yeni bir taraf, verinin sızacağı yeni bir yer. AdOS bu yüzeyi tasarım gereği neredeyse sıfıra indirir. Çalışmak için harici API, API anahtarı ya da internet bağlantısı gerekmez. Çıkarım yerel çalışır; iş içeriği telemetri üretmez; hiçbir şey merkeze rapor vermez. Çevrimdışı öncelikli ve air-gap uyumludur; bu yüzden dışa giden bir bağlantının izin verilmediği ortamlarda çalışabilir. Bir güvenlik ekibi için daha az kapı, savunulacak daha az şey demektir. En güçlü duruş çıkışa daha iyi bir kilit değil — hiç çıkış olmamasıdır.
CTA: Satışla Görüşün
Hashtags: #VeriGüvenliği #AirGap #ZeroTrust #CISO #AdOS
Image suggestion: Dışa giden tüm kapıları mühürlü, içeride tek bir sakin ışık yanan bir bina.
Carousel suggestion: 5 slayt — her bağlantı bir kapıdır, saldırı yüzeyi, harici API/anahtar/internet yok, telemetri yok, savunulacak daha az kapı.
Video suggestion: 30 sn demo: sistem çalışırken sıfır dışa giden ağ çağrısının doğrulanması.

---
## Week 14 · Post 1 (Educational)
...
## Week 14 · Post 2 (Industry insight)

**EN**
**Hook:** "The AI question in the boardroom has changed."
**Body:** Two years ago the question was "should we use AI?" Now it's "can we use AI without sending our knowledge to someone else's servers?" For regulated sectors — finance, healthcare, public institutions — data residency isn't a preference, it's a mandate. That tension is real: teams want the capability but can't accept the exposure. Sovereign Enterprise AI resolves it by moving the AI to the data, not the data to the AI. Inference runs on your own hardware. No cloud, no external API, no per-token bill. The capability without the leak.
**CTA:** Talk to Sales
**Hashtags:** #SovereignAI #DataResidency #CISO #OnPremAI #EnterpriseAI
**Image suggestion:** A building outline with a solid boundary line; data points stay inside the walls.
**Carousel suggestion:** 4 slides — (1) The old question, (2) The new question, (3) Why residency is now a mandate, (4) Move AI to the data.
**Video suggestion:** 30s talking-head: one exec framing the shift from "should we" to "can we, safely."

**TR**
**Hook:** "Yönetim kurulundaki yapay zekâ sorusu değişti."
**Body:** İki yıl önce soru "yapay zekâ kullanmalı mıyız?" idi. Şimdi "bilgimizi başkasının sunucularına göndermeden yapay zekâ kullanabilir miyiz?" oldu. Finans, sağlık, kamu gibi düzenlemeye tabi sektörlerde veri yerleşimi tercih değil, zorunluluktur. Bu gerilim gerçek: ekipler yeteneği istiyor ama riski kabul edemiyor. Egemen Kurumsal Yapay Zekâ bunu, veriyi yapay zekâya değil yapay zekâyı veriye taşıyarak çözer. Çıkarım kendi donanımınızda çalışır. Bulut yok, harici API yok, token başına fatura yok. Sızıntı olmadan yetenek.
**CTA:** Satışla Görüşün
**Hashtags:** #EgemenYapayZeka #VeriYerlesimi #CISO #OnPremAI #KurumsalYapayZeka
**Image suggestion:** Katı bir sınır çizgisiyle bina silüeti; veri noktaları duvarların içinde kalıyor.
**Carousel suggestion:** 4 slayt — (1) Eski soru, (2) Yeni soru, (3) Yerleşim neden artık zorunlu, (4) Yapay zekâyı veriye taşıyın.
**Video suggestion:** 30s konuşan baş: bir yöneticinin "kullanmalı mıyız"dan "güvenle kullanabilir miyiz"e geçişi anlatması.

---

## Week 14 · Post 3 (Product)
...
## Week 15 · Post 1 (Behind the scenes)

**EN**
**Hook:** "We built the demo to fail gracefully — by pulling the network cable."
**Body:** One of our proof moments is deliberately dramatic: mid-demo, we unplug the network. Nothing changes. Answers keep coming, workflows keep moving, citations keep resolving — because AdOS runs entirely on local hardware with no internet required. Building that meant every dependency had to live inside the boundary: the local inference engine, the index, the audit log. No hidden call home. The engineering discipline is simple to state and hard to earn: if it needs the cloud, it doesn't ship. Offline-first isn't a feature we added. It's the constraint we started from.
**CTA:** Request a Demo
**Hashtags:** #AirGap #OnPremAI #EngineeringCulture #DataSovereignty #AdOS
**Image suggestion:** An unplugged ethernet cable resting beside a still-running dashboard.
**Carousel suggestion:** 4 slides — (1) The cable-pull moment, (2) What keeps running, (3) Why every dependency lives inside, (4) Offline-first as a constraint.
**Video suggestion:** 25s clip: hand pulls the cable, camera pans to the screen still answering.

**TR**
**Hook:** "Demoyu zarifçe çökmesi için kurduk — ağ kablosunu çekerek."
**Body:** Kanıt anlarımızdan biri bilinçli olarak çarpıcı: demonun ortasında ağ kablosunu çekiyoruz. Hiçbir şey değişmiyor. Cevaplar gelmeye, iş akışları ilerlemeye, atıflar çözülmeye devam ediyor — çünkü AdOS internet gerektirmeden tamamen yerel donanımda çalışır. Bunu inşa etmek, her bağımlılığın sınır içinde yaşaması demekti: yerel çıkarım motoru, indeks, denetim kaydı. Gizli bir "eve arama" yok. Mühendislik disiplini söylemesi kolay, hak etmesi zor: bulut gerekiyorsa, yayınlanmaz. Çevrimdışı öncelik eklediğimiz bir özellik değil. Başladığımız kısıttır.
**CTA:** Demo Talep Edin
**Hashtags:** #AirGap #OnPremAI #MühendislikKültürü #VeriEgemenligi #AdOS
**Image suggestion:** Hâlâ çalışan bir panonun yanında duran çıkarılmış ethernet kablosu.
**Carousel suggestion:** 4 slayt — (1) Kablo çekme anı, (2) Çalışmaya devam edenler, (3) Her bağımlılık neden içeride, (4) Kısıt olarak çevrimdışı öncelik.
**Video suggestion:** 25s klip: el kabloyu çeker, kamera hâlâ cevap veren ekrana kayar.

---

## Week 15 · Post 2 (Customer story — ILLUSTRATIVE)
...
## Week 15 · Post 3 (Founder perspective)

**EN**
**Hook:** "I stopped believing 'trust us with your data' was an acceptable ask."
**Body:** Every cloud AI pitch ends the same way: send us your knowledge, and we'll be careful with it. For a bank, a hospital, a ministry, that's not a deal — it's a risk transfer they can't sign. I wanted a different answer. Not "we'll protect your data," but "your data never leaves the building." That single constraint shaped everything: local inference, no external API, air-gap capability, no per-token meter. It costs us the easy speed of a hosted frontier model — local CPU inference is seconds, not milliseconds. We say that plainly. Sovereignty is worth the honest trade-off.
**CTA:** Talk to Sales
**Hashtags:** #FounderPerspective #SovereignAI #DataSovereignty #Leadership #OnPremAI
**Image suggestion:** Plain quote card on a near-black canvas with a single accent line.
**Carousel suggestion:** 4 slides — (1) The uncomfortable ask, (2) Why it fails for regulated buyers, (3) The different answer, (4) The honest trade-off.
**Video suggestion:** 40s founder to camera, no music, stating the constraint and the trade-off.

**TR**
**Hook:** "'Verinizi bize emanet edin' talebinin kabul edilebilir olduğuna inanmayı bıraktım."
**Body:** Her bulut yapay zekâ sunumu aynı biter: bilginizi bize gönderin, dikkatli davranırız. Bir banka, bir hastane, bir bakanlık için bu anlaşma değil — imzalayamayacakları bir risk devri. Farklı bir cevap istedim. "Verinizi koruruz" değil, "veriniz binadan hiç çıkmaz." Bu tek kısıt her şeyi şekillendirdi: yerel çıkarım, harici API yok, air-gap yeteneği, token sayacı yok. Bu bize barındırılan bir öncü modelin kolay hızını kaybettiriyor — yerel CPU çıkarımı milisaniye değil, saniye sürer. Bunu açıkça söylüyoruz. Egemenlik, bu dürüst ödünleşmeye değer.
**CTA:** Satışla Görüşün
**Hashtags:** #KurucununBakışı #EgemenYapayZeka #VeriEgemenligi #Liderlik #OnPremAI
**Image suggestion:** Neredeyse siyah zeminde tek vurgu çizgili sade alıntı kartı.
**Carousel suggestion:** 4 slayt — (1) Rahatsız edici talep, (2) Düzenlemeye tabi alıcı için neden başarısız, (3) Farklı cevap, (4) Dürüst ödünleşme.
**Video suggestion:** 40s kurucu kameraya, müziksiz, kısıtı ve ödünleşmeyi anlatıyor.
...
**EN**
**Hook:** "You don't need the cloud to run a capable model. You need the right hardware."
**Body:** A common myth: serious AI only lives in a hyperscaler's data center. It doesn't. AdOS runs inference locally through open engines — Ollama, or any OpenAI-compatible server like vLLM, LM Studio, llama.cpp, SGLang. That means no API keys, no external calls, no internet. The honest part: local CPU inference is slower than a hosted frontier API — seconds, not milliseconds. Better hardware closes the gap, and GPUs close it further. You trade a little latency for total control: your model, your data, your electricity bill instead of a per-token meter. For most enterprise work, that's the right trade.
**CTA:** Read the Guide
**Hashtags:** #LocalLLM #Ollama #vLLM #OnPremAI #EnterpriseAI
**Image suggestion:** A rack of on-prem servers with a small "no cloud" boundary icon.
**Carousel suggestion:** 5 slides — (1) The myth, (2) Open engines list, (3) No keys/no internet, (4) The latency trade-off, (5) When it's the right trade.
**Video suggestion:** 35s explainer animation: model weights loading on local hardware, no external link.

**TR**
**Hook:** "Yetenekli bir modeli çalıştırmak için buluta değil, doğru donanıma ihtiyacınız var."
**Body:** Yaygın bir efsane: ciddi yapay zekâ yalnızca bir hiperölçekleyicinin veri merkezinde yaşar. Yaşamaz. AdOS çıkarımı açık motorlarla yerelde çalıştırır — Ollama ya da vLLM, LM Studio, llama.cpp, SGLang gibi OpenAI uyumlu herhangi bir sunucu. Yani API anahtarı yok, harici çağrı yok, internet yok. Dürüst kısım: yerel CPU çıkarımı barındırılan bir öncü API'den yavaştır — milisaniye değil, saniye. Daha iyi donanım farkı kapatır, GPU'lar daha da kapatır. Biraz gecikmeyi tam kontrol karşılığında verirsiniz: sizin modeliniz, sizin veriniz, token sayacı yerine elektrik faturanız. Çoğu kurumsal iş için doğru takas budur.
**CTA:** Rehberi Okuyun
**Hashtags:** #YerelLLM #Ollama #vLLM #OnPremAI #KurumsalYapayZeka
**Image suggestion:** Küçük bir "bulut yok" sınır ikonuyla on-prem sunucu rafı.
**Carousel suggestion:** 5 slayt — (1) Efsane, (2) Açık motor listesi, (3) Anahtar yok/internet yok, (4) Gecikme takası, (5) Ne zaman doğru takas.
**Video suggestion:** 35s açıklayıcı animasyon: model ağırlıkları yerel donanıma yükleniyor, harici bağlantı yok.

---

## Week 16 · Post 2 (Knowledge)
...
**Body:** Çoğu kurumda cevap evet. On yılların birikmiş muhakemesi — zor hattın nasıl idare edileceği, hangi tedarikçinin aranacağı, istisnanın gerçekte ne anlama geldiği — kapıdan çıkıp gidiyor. Company Brain bu kurumsal bilgiyi kaybolmadan önce yakalar. Belgeler, prosedürler ve kararlar biriktikçe; yeni işe alınanların ilk gün sorgulayabileceği atıflı, aranabilir, yetki farkındalıklı bir tabana dönüşürler. İnsanlar ayrılsa bile bilgi duvarların içinde kalır. Bu bir dosya dolabı değil; kurumunuzun sahip olduğu canlı bir hafızadır — gerçek kaynaklara dayanan ve yalnızca her kullanıcının görmeye yetkili olduğundan cevap veren.
**CTA:** Platformu Keşfedin
**Hashtags:** #BilgiYönetimi #BilgininKorunması #CompanyBrain #İnsanKaynakları #KurumsalYapayZeka
**Image suggestion:** İçinde ışık olan sağlam taş arşiv-bina metaforu — beyin klişesi yok.
**Carousel suggestion:** 5 slayt — (1) Emeklilik sorunu, (2) Örtük bilgi gidiyor, (3) Biriktikçe yakala, (4) İlk gün sorgula, (5) Sahip olduğunuz hafıza.
**Video suggestion:** 40s: ayrılan uzman ile yeni çalışanın aynı atıflı cevabı aldığı bölünmüş ekran.

---

## Week 16 · Post 3 (Enterprise)

**EN**
**Hook:** "One deployment. Many units. Zero data crossing where it shouldn't."
**Body:** Large organizations aren't monoliths — they're sites, units, and departments with different access rules. AdOS is multi-tenant with strict tenant isolation, so a shared platform never becomes a shared exposure. A user in one business unit can't surface another's restricted documents, and the AI can't cite what that user can't open. Deployment is standard Docker with a one-command bring-up, plus documented backup, restore, upgrade, and disaster-recovery runbooks. It's built for IT/BT teams who have to run it on day 2, not just launch it on day 1 — on-premise or in your private cloud, entirely under your control.
**CTA:** See the Platform
...
**Carousel suggestion:** 5 slayt — (1) Tek parça değil, (2) Kiracı izolasyonu, (3) Yetki bazlı atıflar, (4) Tek komutla Docker, (5) 2. gün kılavuzları.
**Video suggestion:** 45s: terminalde tek komutla ayağa kalkış, ardından yalıtılmış birimli pano.

---

## Week 17 · Post 1 (Security)
...
## Week 17 · Post 3 (Industry insight)

**EN**
**Hook:** "The 'per-token' meter is a strategy tax you didn't vote for."
**Body:** Hosted AI charges by usage. The more your teams rely on it, the more you pay — and the harder it is to forecast. That model quietly discourages the very adoption you're trying to drive. AdOS removes the meter entirely. Inference cost is your own electricity and hardware, not a per-query invoice that scales with success. You license the platform and support; you don't pay a tax on curiosity. For a large workforce asking thousands of questions a day, unmetered isn't a nice-to-have — it's what makes broad, everyday use financially sane.
**CTA:** Calculate Your ROI
**Hashtags:** #AIeconomics #TCO #NoPerTokenBilling #CFO #OnPremAI
**Image suggestion:** A taxi-style meter crossed out beside a flat platform-license icon.
**Carousel suggestion:** 4 slides — (1) The meter problem, (2) It punishes adoption, (3) Unmetered by design, (4) Why scale changes the math.
**Video suggestion:** 30s: a spinning usage meter vs a flat line; adoption curve rising without cost spikes.

**TR**
**Hook:** "'Token başına' sayaç, oyunu vermediğiniz bir strateji vergisidir."
**Body:** Barındırılan yapay zekâ kullanıma göre ücretlendirir. Ekipleriniz ona ne kadar güvenirse o kadar ödersiniz — ve tahmin etmek o kadar zorlaşır. Bu model, tetiklemeye çalıştığınız benimsemeyi sessizce caydırır. AdOS sayacı tamamen kaldırır. Çıkarım maliyeti, başarıyla ölçeklenen sorgu başına fatura değil, kendi elektriğiniz ve donanımınızdır. Platformu ve desteği lisanslarsınız; meraka vergi ödemezsiniz. Günde binlerce soru soran büyük bir işgücü için sayaçsızlık lüks değildir — geniş, günlük kullanımı mali açıdan mantıklı kılan şeydir.
**CTA:** ROI'nizi Hesaplayın
**Hashtags:** #YapayZekaEkonomisi #TCO #TokenBaşınaFaturaYok #CFO #OnPremAI
**Image suggestion:** Sabit platform lisansı ikonunun yanında üstü çizili taksimetre.
**Carousel suggestion:** 4 slayt — (1) Sayaç sorunu, (2) Benimsemeyi cezalandırır, (3) Tasarımla sayaçsız, (4) Ölçek matematiği nasıl değiştirir.
**Video suggestion:** 30s: dönen kullanım sayacı ile düz çizgi; maliyet sıçraması olmadan yükselen benimseme eğrisi.

---

## Week 18 · Post 1 (Product)
...
## Week 18 · Post 2 (Behind the scenes)

**EN**
**Hook:** "We ship a disaster-recovery runbook before we ship the celebration."
**Body:** New AI products love a launch video. We spent that energy on backup, restore, upgrade, and disaster-recovery runbooks — documented, tested, versioned with the product at 1.0.0. Why? Because a sovereign system you run yourself has to be one you can also recover yourself, without calling a vendor's cloud. Standard Docker, one-command bring-up, and clear day-2 procedures aren't glamorous, but they're what a CIO actually signs off on. The pillar we care about here is Accountable: you own the stack, so we make sure you can operate it — on the worst day, not just the demo day.
**CTA:** See the Platform
**Hashtags:** #DevOps #DisasterRecovery #ITOps #OnPremAI #AdOS
**Image suggestion:** A tabbed runbook binder labeled Backup / Restore / Upgrade / DR.
**Carousel suggestion:** 4 slides — (1) Runbook before hype, (2) What's documented, (3) Recover it yourself, (4) Accountable pillar.
**Video suggestion:** 40s: an engineer runs a restore drill end to end, timer visible.

**TR**
**Hook:** "Kutlamayı yayınlamadan önce felaket kurtarma kılavuzunu yayınlarız."
**Body:** Yeni yapay zekâ ürünleri lansman videosunu sever. Biz o enerjiyi yedekleme, geri yükleme, yükseltme ve felaket kurtarma kılavuzlarına harcadık — belgelenmiş, test edilmiş, ürünle birlikte 1.0.0 sürümüne işaretlenmiş. Neden? Çünkü kendinizin çalıştırdığı egemen bir sistem, bir tedarikçinin bulutunu aramadan yine kendinizin kurtarabileceği bir sistem olmalı. Standart Docker, tek komutla ayağa kalkış ve net 2. gün prosedürleri gösterişli değildir ama bir CIO'nun gerçekten onayladığı şeydir. Burada önemsediğimiz sütun Hesap Verebilir: yığına siz sahipsiniz, biz de onu işletebilmenizi sağlıyoruz — demo gününde değil, en kötü günde.
**CTA:** Platformu Keşfedin
**Hashtags:** #DevOps #FelaketKurtarma #BTOperasyon #OnPremAI #AdOS
**Image suggestion:** Yedekleme / Geri Yükleme / Yükseltme / DR etiketli sekmeli kılavuz klasörü.
**Carousel suggestion:** 4 slayt — (1) Hype'tan önce kılavuz, (2) Neler belgeli, (3) Kendiniz kurtarın, (4) Hesap Verebilir sütunu.
**Video suggestion:** 40s: bir mühendis baştan sona geri yükleme tatbikatı yapar, sayaç görünür.

---

## Week 18 · Post 3 (Customer story — ILLUSTRATIVE)
...
## Week 19 · Post 1 (Founder perspective)

**EN**
**Hook:** "'No vendor lock-in' should be provable, not promised."
**Body:** Every vendor says you're free to leave. Few build it so you actually can. We made portability a design rule, not a marketing line. AdOS runs on open engines with an OpenAI-compatible interface, so you can change the model underneath without changing the platform. Your data is exportable — it's yours, sitting on your hardware, in formats you can take with you. There are no API keys tying you to one provider and no per-token contract to escape. Lock-in is a business model choice. We chose the opposite, because a system you truly own is the only kind worth calling sovereign.
**CTA:** Talk to Sales
**Hashtags:** #FounderPerspective #NoVendorLockIn #OpenStandards #SovereignAI #OnPremAI
**Image suggestion:** An open door in a solid wall — you can leave, but the walls still protect the data.
**Carousel suggestion:** 4 slides — (1) Everyone claims freedom, (2) OpenAI-compatible interface, (3) Exportable data, (4) Lock-in is a choice.
**Video suggestion:** 35s founder to camera on why portability had to be provable.

**TR**
**Hook:** "'Tedarikçi kilidi yok' vaat değil, kanıtlanabilir olmalı."
**Body:** Her tedarikçi ayrılmakta özgür olduğunuzu söyler. Çok azı gerçekten ayrılabileceğiniz şekilde inşa eder. Taşınabilirliği pazarlama cümlesi değil, tasarım kuralı yaptık. AdOS, OpenAI uyumlu bir arayüzle açık motorlarda çalışır; böylece platformu değiştirmeden altındaki modeli değiştirebilirsiniz. Verileriniz dışa aktarılabilir — sizindir, kendi donanımınızda, yanınızda götürebileceğiniz biçimlerde. Sizi tek bir sağlayıcıya bağlayan API anahtarı ve kaçmanız gereken token başına sözleşme yoktur. Kilit, bir iş modeli tercihidir. Biz tersini seçtik; çünkü gerçekten sahip olduğunuz bir sistem, egemen denmeye değer tek türdür.
**CTA:** Satışla Görüşün
**Hashtags:** #KurucununBakışı #TedarikçiKilidiYok #AçıkStandartlar #EgemenYapayZeka #OnPremAI
**Image suggestion:** Sağlam bir duvarda açık kapı — çıkabilirsiniz ama duvarlar veriyi hâlâ korur.
**Carousel suggestion:** 4 slayt — (1) Herkes özgürlük iddia eder, (2) OpenAI uyumlu arayüz, (3) Dışa aktarılabilir veri, (4) Kilit bir tercihtir.
**Video suggestion:** 35s kurucu kameraya: taşınabilirliğin neden kanıtlanabilir olması gerektiği.
...
## Week 19 · Post 3 (Knowledge)

**EN**
**Hook:** "Onboarding a new hire shouldn't mean rebuilding your company's memory in their head."
...
**TR**
**Hook:** "Yeni bir çalışanı işe almak, şirketin hafızasını onun kafasında yeniden kurmak olmamalı."
**Body:** Yeni çalışanlar haftalarca meslektaşlarına neyin nerede olduğunu ve işlerin nasıl yürüdüğünü sorar. Her soru kıdemli birini böler. Company Brain bu eğriyi kısaltır: yeni bir çalışan ilk gün kurumun kendi atıflı bilgisini sorgular ve görmeye izinli olduğuyla sınırlı, dayanaklı cevaplar alır. Prosedürler, geçmiş kararlar ve sahaya özgü bilgi zaten oradadır, aranabilir ve kaynaklıdır. Kıdemli uzman artık bir yardım masası değildir, yeni çalışan da cevap beklerken tıkanmaz. Daha hızlı uyum, daha düşük eğitim yükü ve biri her ayrıldığında sıfırlanmak yerine biriken bilgi. Sizin, kendi altyapınızda.
**CTA:** Platformu Keşfedin
**Hashtags:** #Oryantasyon #BilgiYönetimi #İnsanKaynakları #CompanyBrain #KurumsalYapayZeka
**Image suggestion:** "İlk gün atıflı cevaplar" notlu dikleşen uyum eğrisi.
**Carousel suggestion:** 5 slayt — (1) Oryantasyon yükü, (2) İlk gün sorguları, (3) Sınırlı, atıflı cevaplar, (4) Uzmanlar rahatladı, (5) Biriken bilgi.
**Video suggestion:** 40s: bir çalışanın ilk haftası sıkıştırılmış, sorular Company Brain'den yanıtlanmış.

---

## Week 20 · Post 1 (Enterprise)
...
**Carousel suggestion:** 5 slides — (1) OSB shape, (2) Shared need, strict boundaries, (3) Multi-tenant isolation, (4) Zone-controlled infra, (5) Shared service, no shared risk.
**Video suggestion:** 40s: an OSB serving three member firms, each firm's data sealed on screen.

**TR**
**Hook:** "Organize sanayi bölgeleri ortak yapay zekâ ister — ortak riske girmeden."
**Body:** Organize Sanayi Bölgeleri (OSB), örtüşen ihtiyaçları ve katı sınırları olan onlarca üye firmayı barındırır. AdOS bu yapıya uyar: katı izolasyonlu çok kiracılık, bir OSB'nin üyelerine egemen yapay zekâ hizmetleri sunarken her firmanın verisinin diğerlerinden mühürlü kalması demektir. Tek kurulum, çok kiracı, sıfır çapraz bulaşma — her cevap yetki bazlı, her eylem denetimli. Bölgenin kontrol ettiği altyapıda çalışır, çevrimdışı yeteneklidir ve aktarılacak token başına fatura yoktur. OSB'ler için bu, hizmet verdikleri üyeler için veri sızıntısı riskine dönüşmeden modern yapay zekâyı ortak hizmet olarak sunmanın yoludur.
**CTA:** Satışla Görüşün
**Hashtags:** #OSB #OrganizeSanayiBölgeleri #ÇokKiracılı #EgemenYapayZeka #OnPremAI
**Image suggestion:** Tek bir yönetilen çatı altında mühürlü üye-firma karolarıyla bölge haritası.
**Carousel suggestion:** 5 slayt — (1) OSB yapısı, (2) Ortak ihtiyaç, katı sınırlar, (3) Çok kiracılı izolasyon, (4) Bölge kontrollü altyapı, (5) Ortak hizmet, ortak risk yok.
**Video suggestion:** 40s: üç üye firmaya hizmet veren bir OSB, her firmanın verisi ekranda mühürlü.

---

## Week 20 · Post 2 (Security)
...
**Carousel suggestion:** 4 slides — (1) The "who did what" question, (2) Immutable by default, (3) Provable, not editable, (4) Why regulators need it.
...
**Carousel suggestion:** 4 slayt — (1) "Kim ne yaptı" sorusu, (2) Varsayılan değiştirilemez, (3) Düzenlenebilir değil, kanıtlanabilir, (4) Düzenleyiciler neden ister.
**Video suggestion:** 35s: bir denetçi kilitli izi kaydırır; kayıtlar düzenlenemez, yalnızca okunur.

---

## Week 20 · Post 3 (Educational)
...
**Carousel suggestion:** 5 slides — (1) What air-gap means, (2) Why most AI can't run there, (3) Offline-first design, (4) Same features, disconnected, (5) When it's mandatory.
**Video suggestion:** 35s: a disconnected network runs the full platform; internet icon greyed out.
...
**Carousel suggestion:** 5 slayt — (1) Air-gap nedir, (2) Çoğu yapay zekâ neden çalışamaz, (3) Çevrimdışı öncelikli tasarım, (4) Aynı özellikler, kopuk, (5) Ne zaman zorunlu.
**Video suggestion:** 35s: kopuk bir ağ tüm platformu çalıştırır; internet ikonu soluk.

---

## Week 21 · Post 1 (Industry insight)
...
**Carousel suggestion:** 4 slayt — (1) Klinik fayda, (2) Bulut neden imkânsız, (3) Her şey içeride kalır, (4) Yetki farkındalıklı + denetimli.
**Video suggestion:** 30s: bir klinisyen atıflı cevap alır; kayıt hastane ağından çıkmaz.

---

## Week 21 · Post 2 (Product)
...
## Week 21 · Post 3 (Behind the scenes)
...
**Carousel suggestion:** 5 slides — (1) Meet NovaMak (fictional), (2) The fixed numbers, (3) Why deterministic, (4) Proof, not theatre, (5) Test the mechanism yourself.
**Video suggestion:** 40s: the same query run twice, identical cited results side by side.
...
**Carousel suggestion:** 5 slayt — (1) NovaMak ile tanışın (kurgusal), (2) Sabit sayılar, (3) Neden belirlenimci, (4) Tiyatro değil kanıt, (5) Mekanizmayı kendiniz test edin.
**Video suggestion:** 40s: aynı sorgu iki kez çalıştırılır, birebir aynı atıflı sonuçlar yan yana.

---

## Week 22 · Post 1 (Customer story — ILLUSTRATIVE)
...
## Week 22 · Post 2 (Founder perspective)

**EN**
**Hook:** "We concede our weakness on purpose. It's how we earn the sale."
**Body:** Here's something most AI vendors won't print: local CPU inference is slower than a hosted frontier API. Seconds, not milliseconds. We say it in the first meeting, not the fine print. Why volunteer a weakness? Because the buyers we serve are skeptical experts, and honesty is the fastest path to their trust. When we concede the one real trade-off — and explain that better hardware and GPUs close the gap — the rest of our claims become believable. Sovereignty, no data leaving the building, no per-token bill: all true, all provable. Trust is built at the point where you admit what's hard.
**CTA:** Talk to Sales
**Hashtags:** #FounderPerspective #HonestMarketing #Trust #OnPremAI #SovereignAI
**Image suggestion:** A plain quote card: "Seconds, not milliseconds." on a near-black canvas.
**Carousel suggestion:** 4 slides — (1) The thing vendors won't print, (2) The real trade-off, (3) How the gap closes, (4) Why honesty wins the sale.
**Video suggestion:** 40s founder to camera stating the trade-off first, then the sovereignty payoff.

**TR**
**Hook:** "Zayıflığımızı bilerek kabul ediyoruz. Satışı böyle hak ediyoruz."
**Body:** Çoğu yapay zekâ tedarikçisinin yazmayacağı bir şey: yerel CPU çıkarımı barındırılan bir öncü API'den yavaştır. Milisaniye değil, saniye. Bunu ince yazıda değil, ilk toplantıda söylüyoruz. Zayıflığı neden gönüllü açıklamak? Çünkü hizmet verdiğimiz alıcılar şüpheci uzmanlardır ve dürüstlük, güvenlerine giden en hızlı yoldur. Tek gerçek ödünleşmeyi kabul ettiğimizde — ve daha iyi donanım ile GPU'ların farkı kapattığını anlattığımızda — diğer iddialarımız inandırıcı olur. Egemenlik, verinin binadan çıkmaması, token başına fatura olmaması: hepsi doğru, hepsi kanıtlanabilir. Güven, zoru itiraf ettiğiniz noktada kurulur.
**CTA:** Satışla Görüşün
**Hashtags:** #KurucununBakışı #DürüstPazarlama #Güven #OnPremAI #EgemenYapayZeka
**Image suggestion:** Neredeyse siyah zeminde sade alıntı kartı: "Milisaniye değil, saniye."
**Carousel suggestion:** 4 slayt — (1) Tedarikçilerin yazmadığı şey, (2) Gerçek ödünleşme, (3) Fark nasıl kapanır, (4) Dürüstlük satışı neden kazanır.
**Video suggestion:** 40s kurucu kameraya: önce ödünleşme, sonra egemenlik getirisi.
...
**EN**
**Hook:** "Your model should be a component you can swap, not a landlord you can't leave."
**Body:** Model choice moves fast. What's best this quarter may not be best next quarter. AdOS treats the model as a replaceable component: it runs on open engines behind an OpenAI-compatible interface, so you can change the underlying model — a newer open weight, a domain-tuned one, a bigger one for more capable hardware — without re-architecting the platform. No API keys binding you to one provider, no contract to renegotiate. The Company Brain, permissions, workflows, and audit trail stay exactly the same; only the engine underneath changes. That's how a sovereign system stays current: you own the choice, permanently.
**CTA:** See the Platform
**Hashtags:** #LocalLLM #ModelChoice #OpenStandards #NoVendorLockIn #OnPremAI
**Image suggestion:** A model chip sliding out and a new one sliding into the same socket.
**Carousel suggestion:** 5 slides — (1) Model choice moves fast, (2) Model as component, (3) OpenAI-compatible swap, (4) Platform unchanged, (5) You own the choice.
**Video suggestion:** 35s: swapping the underlying model while the platform keeps running.
...
**Carousel suggestion:** 5 slayt — (1) Model tercihi hızlı değişir, (2) Bileşen olarak model, (3) OpenAI uyumlu değişim, (4) Platform değişmez, (5) Seçim sizindir.
**Video suggestion:** 35s: platform çalışmaya devam ederken altındaki modelin değiştirilmesi.

---

## Week 23 · Post 1 (Knowledge)
...
**Carousel suggestion:** 5 slides — (1) You have info, not access, (2) The scatter problem, (3) One cited base, (4) Plain-language questions, (5) Pile becomes knowledge.
**Video suggestion:** 40s: messy folders resolving into a single searchable Company Brain answer.

**TR**
**Hook:** "Dağınık belgeler bilgi değildir. Bir arama sorunudur."
**Body:** Çoğu kurumda bilgi eksik değildir — ona erişim eksiktir. Sürücülere, gelen kutularına, wiki'lere ve baskı altında kimsenin bulamadığı PDF'lere yayılmıştır. Company Brain bu dağınıklığı tek, atıflı, yetki farkındalıklı bir tabana dönüştürür. Sade bir dille soru sorun; gerçek belgelere dayanan, kaynağı iliştirilmiş, açmaya izinli olduğunuzla sınırlı bir cevap alın. Belgeler olduğu yerde kalır ve sizin kalır — hiçbir şey tesisten çıkmaz. Değişim, "bununla ilgili bir yerlerde bir politikamız var"dan "işte politika, işte paragraf"a geçiştir. Bir belge yığını kullanılabilir bilgiye işte o zaman dönüşür.
**CTA:** Platformu Keşfedin
**Hashtags:** #BilgiYönetimi #KurumsalArama #CompanyBrain #VeriEgemenligi #KurumsalYapayZeka
**Image suggestion:** Dağınık belge ikonlarının tek bir dayanaklı, atıflı yapıya yakınsaması.
**Carousel suggestion:** 5 slayt — (1) Bilgi var, erişim yok, (2) Dağınıklık sorunu, (3) Tek atıflı taban, (4) Sade dille sorular, (5) Yığın bilgiye dönüşür.
**Video suggestion:** 40s: dağınık klasörlerin tek bir aranabilir Company Brain cevabına çözülmesi.

---

## Week 23 · Post 2 (Enterprise)

**EN**
**Hook:** "CIOs don't buy demos. They buy what they can run on day 2."
**Body:** The demo is the easy part. What decides an enterprise purchase is operability: can my team deploy it, back it up, upgrade it, and recover it — without a vendor's cloud in the loop? AdOS is built for that reality. Standard Docker with a one-command bring-up. Documented backup, restore, upgrade, and disaster-recovery runbooks, versioned with the product. Multi-tenant isolation for many units on one deployment. It runs on-premise or in your private cloud, fully under IT/BT control. We optimize for the unglamorous middle of the lifecycle, because that's where a sovereign system either earns its keep or becomes a liability.
**CTA:** See the Platform
**Hashtags:** #CIO #EnterpriseIT #Docker #DisasterRecovery #OnPremAI
**Image suggestion:** A lifecycle ring — deploy, operate, back up, upgrade, recover — all inside your boundary.
**Carousel suggestion:** 5 slides — (1) Demo is easy, (2) Day-2 is the decision, (3) One-command Docker, (4) DR runbooks, (5) IT/BT in control.
**Video suggestion:** 45s: deploy → back up → upgrade → restore, all shown in one continuous take.

**TR**
**Hook:** "CIO'lar demo satın almaz. 2. günde çalıştırabileceklerini satın alır."
**Body:** Demo kolay kısımdır. Kurumsal satın almayı belirleyen şey işletilebilirliktir: ekibim bunu bir tedarikçinin bulutu devrede olmadan kurabilir, yedekleyebilir, yükseltebilir ve kurtarabilir mi? AdOS bu gerçeklik için kurulmuştur. Tek komutla ayağa kalkan standart Docker. Ürünle sürümlenmiş, belgelenmiş yedekleme, geri yükleme, yükseltme ve felaket kurtarma kılavuzları. Tek kurulumda çok birim için çok kiracılı izolasyon. On-premise ya da özel bulutunuzda, tamamen IT/BT kontrolünde çalışır. Yaşam döngüsünün gösterişsiz ortasına göre iyileştiriyoruz; çünkü egemen bir sistem ya orada değerini kanıtlar ya da yüke dönüşür.
**CTA:** Platformu Keşfedin
**Hashtags:** #CIO #KurumsalBT #Docker #FelaketKurtarma #OnPremAI
**Image suggestion:** Sınırınız içinde bir yaşam döngüsü halkası — kur, işlet, yedekle, yükselt, kurtar.
**Carousel suggestion:** 5 slayt — (1) Demo kolay, (2) Karar 2. gün, (3) Tek komutla Docker, (4) DR kılavuzları, (5) IT/BT kontrolde.
**Video suggestion:** 45s: kur → yedekle → yükselt → geri yükle, tek çekimde.

---

## Week 23 · Post 3 (Security)

**EN**
**Hook:** "Ask your AI vendor one question: where do my prompts go?"
**Body:** With hosted AI, a prompt is data in motion — it leaves your network, hits an external service, and may be logged somewhere you don't control. For sensitive queries, the prompt itself can reveal as much as the answer. AdOS closes that gap: prompts, documents, answers, and workflows never leave your premises, and there's no telemetry of business content. Nothing to intercept in transit, nothing logged off-site, nothing to subpoena from a third party. For a CISO drawing a data-flow diagram, the AdOS line is short — it starts and ends inside your boundary. That's the whole point of sovereign AI.
**CTA:** Talk to Sales
**Hashtags:** #CISO #DataInMotion #PromptSecurity #ZeroTelemetry #OnPremAI
**Image suggestion:** A prompt icon that loops back inside the boundary instead of exiting.
**Carousel suggestion:** 4 slides — (1) Prompts are data in motion, (2) What a prompt can reveal, (3) Nothing leaves, no telemetry, (4) The short data-flow line.
**Video suggestion:** 30s: a data-flow diagram where the AdOS path never crosses the perimeter.

**TR**
**Hook:** "Yapay zekâ tedarikçinize tek bir soru sorun: istemlerim nereye gidiyor?"
**Body:** Barındırılan yapay zekâda bir istem, hareket halindeki veridir — ağınızdan çıkar, harici bir servise gider ve kontrol etmediğiniz bir yerde kaydedilebilir. Hassas sorgularda istemin kendisi, cevap kadar çok şey açığa çıkarabilir. AdOS bu açığı kapatır: istemler, belgeler, cevaplar ve iş akışları tesisinizden hiç çıkmaz ve iş içeriğine dair telemetri yoktur. Aktarımda ele geçirilecek bir şey yok, saha dışında kaydedilen bir şey yok, üçüncü taraftan celple istenecek bir şey yok. Bir CISO veri akış şeması çizerken, AdOS satırı kısadır — sınırınızın içinde başlar ve biter. Egemen yapay zekânın bütün amacı budur.
**CTA:** Satışla Görüşün
**Hashtags:** #CISO #HareketHalindeVeri #İstemGüvenliği #SıfırTelemetri #OnPremAI
**Image suggestion:** Dışarı çıkmak yerine sınırın içine dönen istem ikonu.
**Carousel suggestion:** 4 slayt — (1) İstemler hareket halinde veri, (2) İstem ne açığa çıkarır, (3) Hiçbir şey çıkmaz, telemetri yok, (4) Kısa veri akış satırı.
**Video suggestion:** 30s: AdOS yolunun çevreyi hiç geçmediği bir veri akış şeması.

---

## Week 24 · Post 1 (Educational)

**EN**
**Hook:** "Cloud AI vs local AI: it's not speed vs security. It's whose building the data sits in."
**Body:** The usual framing pits convenience against control. The real difference is simpler: with hosted AI, your knowledge sits in someone else's data center; with AdOS, it sits in yours. That single fact drives everything else. No data leaves your premises. No per-token bill, because inference is your own hardware. No internet dependency, so it works air-gapped. The honest cost: local inference is seconds, not milliseconds — better hardware narrows it. If your data can live in the cloud, the cloud is fine. If it can't, local isn't a compromise; it's the only option that respects that constraint.
**CTA:** Read the Guide
**Hashtags:** #CloudVsLocal #OnPremAI #DataSovereignty #EnterpriseAI #LocalLLM
**Image suggestion:** Two buildings side by side; data glowing inside the one you own.
**Carousel suggestion:** 5 slides — (1) The false framing, (2) Whose building?, (3) What follows: no leaving/no meter/air-gap, (4) The honest cost, (5) When local is the only option.
**Video suggestion:** 40s: a data cube moving to "someone else's building" vs staying in yours.

**TR**
**Hook:** "Bulut yapay zekâ ile yerel yapay zekâ: mesele hız mı güvenlik mi değil. Verinin hangi binada durduğudur."
**Body:** Alışılmış çerçeve kolaylığı kontrole karşı koyar. Gerçek fark daha basit: barındırılan yapay zekâda bilginiz başkasının veri merkezinde durur; AdOS'ta sizinkinde. Bu tek gerçek diğer her şeyi belirler. Veri tesisinizden çıkmaz. Token başına fatura yok, çünkü çıkarım kendi donanımınız. İnternet bağımlılığı yok, bu yüzden air-gap'te çalışır. Dürüst maliyet: yerel çıkarım milisaniye değil saniye — daha iyi donanım daraltır. Veriniz bulutta yaşayabiliyorsa bulut sorun değil. Yaşayamıyorsa, yerel bir taviz değildir; bu kısıta saygı duyan tek seçenektir.
**CTA:** Rehberi Okuyun
**Hashtags:** #BulutMuYerelMi #OnPremAI #VeriEgemenligi #KurumsalYapayZeka #YerelLLM
**Image suggestion:** Yan yana iki bina; veri, sahip olduğunuz binanın içinde parlıyor.
**Carousel suggestion:** 5 slayt — (1) Yanlış çerçeve, (2) Kimin binası?, (3) Sonuçlar: çıkmaz/sayaç yok/air-gap, (4) Dürüst maliyet, (5) Yerel ne zaman tek seçenek.
**Video suggestion:** 40s: bir veri küpünün "başkasının binasına" gitmesi ile sizinkinde kalması.

---

## Week 24 · Post 2 (Industry insight)
...
**Carousel suggestion:** 5 slayt — (1) Perakendenin gerçek maliyeti, (2) Aynı soru, bin kez, (3) Tutarlı atıflı cevaplar, (4) Ölçekte sayaçsız, (5) Bilgi devirde kalır.
**Video suggestion:** 35s: farklı mağazalardaki üç çalışanın birebir aynı atıflı cevabı alması.

---

## Week 24 · Post 3 (Product)
...
**Carousel suggestion:** 5 slides — (1) Bilingual by design, (2) Auto-detected TR/EN, (3) Ask in Turkish, cited in Turkish, (4) Identical behavior both ways, (5) Product names stay English.
**Video suggestion:** 40s: the same query run in Turkish and English, matching cited results.
...
**Carousel suggestion:** 5 slayt — (1) Tasarımla iki dilli, (2) Otomatik algılanan TR/EN, (3) Türkçe sor, Türkçe atıf, (4) İki yönde aynı davranış, (5) Ürün adları İngilizce.
**Video suggestion:** 40s: aynı sorgunun Türkçe ve İngilizce çalıştırılması, eşleşen atıflı sonuçlar.

---

## Week 25 · Post 1 (Behind the scenes)
...
## Week 25 · Post 2 (Customer story — ILLUSTRATIVE)
...
**TR**
**Hook:** "Örnek: bir belediye, dosyaları açığa çıkarmadan vatandaşa cevap veriyor."
**Body:** Kurgusal, örnekleyici bir senaryo (gerçek kurum değil). Orta ölçekli bir belediye her gün aynı vatandaş ve iç soruları karşılıyor — ruhsatlar, prosedürler, geçmiş kararlar. Memurlar arşivleri karıştırıyor; cevap kime sorduğunuza göre değişiyor. Senaryoda AdOS, veri yerleşimi kurallarının zorunlu kıldığı üzere belediyenin kendi sunucularında çalışıyor. Company Brain memurlara resmi kayıtlardan atıflı, tutarlı cevaplar veriyor; yetki bazlı olduğundan hassas dosyalar yetkisiz personele asla görünmüyor. Her erişim denetleniyor. Hiçbir vatandaş verisi buluta değmiyor. Bu, uydurma veri üzerinde mekanizmanın gösterimidir — değeri örnekler, adı belirtilmiş bir kamu kurumu iddiası değildir.
**CTA:** Demo Talep Edin
**Hashtags:** #KamuSektörü #Belediye #VeriYerlesimi #CompanyBrain #OnPremAI
**Image suggestion:** Kayıtların içeride kaldığı bir kamu binası; "Örnektir" işaretli.
**Carousel suggestion:** 5 slayt — (1) Belediye (kurgusal) kurulumu, (2) Günlük sorular, (3) Zorunluluktan on-prem, (4) Atıflı + yetki bazlı, (5) Denetimli, buluta hiçbir şey gitmez.
**Video suggestion:** 45s: bir memurun atıflı kayıtlardan vatandaşa cevap vermesi; "Örnek demo" filigranı.

---

## Week 25 · Post 3 (Founder perspective)

**EN**
**Hook:** "We're not building the best cloud assistant. We're building the alternative to needing one."
**Body:** The market is crowded with assistants that get smarter the more of your data they hold. We chose a different bet: that a large set of serious organizations will never be allowed to hand over that data — and that they deserve real AI anyway. So we're not competing on the cloud's terms. We define a different category: Sovereign Enterprise AI, living entirely inside the customer's walls. It's a harder path — you own the hardware, you accept a latency trade-off — but it's the only one that keeps the data where regulation, risk, and common sense say it belongs. Inside your building.
**CTA:** Talk to Sales
**Hashtags:** #FounderPerspective #SovereignAI #CategoryDesign #OnPremAI #EnterpriseAI
**Image suggestion:** Two diverging paths from one fork; ours leads into a walled compound.
**Carousel suggestion:** 4 slides — (1) The crowded cloud, (2) Our different bet, (3) A new category, (4) Why the harder path is right.
**Video suggestion:** 40s founder to camera on choosing to define a category, not chase one.

**TR**
**Hook:** "En iyi bulut asistanını inşa etmiyoruz. Ona ihtiyaç duymamanın alternatifini inşa ediyoruz."
**Body:** Piyasa, verinizi ne kadar çok tutarsa o kadar akıllanan asistanlarla dolu. Biz farklı bir bahse girdik: ciddi kurumların büyük bir kısmının bu veriyi asla teslim etmesine izin verilmeyeceğine — ve yine de gerçek yapay zekâyı hak ettiklerine. Bu yüzden bulutun şartlarıyla rekabet etmiyoruz. Farklı bir kategori tanımlıyoruz: tamamen müşterinin duvarları içinde yaşayan Egemen Kurumsal Yapay Zekâ. Daha zor bir yol — donanıma siz sahip olursunuz, bir gecikme ödünleşmesini kabul edersiniz — ama veriyi düzenleme, risk ve sağduyunun ait olduğunu söylediği yerde tutan tek yol. Binanızın içinde.
**CTA:** Satışla Görüşün
**Hashtags:** #KurucununBakışı #EgemenYapayZeka #KategoriTasarımı #OnPremAI #KurumsalYapayZeka
**Image suggestion:** Tek bir çataldan ayrılan iki yol; bizimki duvarlı bir yerleşkeye götürüyor.
**Carousel suggestion:** 4 slayt — (1) Kalabalık bulut, (2) Farklı bahsimiz, (3) Yeni bir kategori, (4) Zor yol neden doğru.
**Video suggestion:** 40s kurucu kameraya: bir kategoriyi kovalamak değil tanımlamak.
...
**EN**
**Hook:** "The most dangerous AI output is the one that's fluent and wrong."
**Body:** A confident, well-written wrong answer is worse than no answer — it gets acted on. General models produce these when asked about specifics they were never trained on: your policies, your procedures, your exceptions. AdOS reduces that risk by construction. Company Brain grounds every answer in your own documents and attaches the source, so you can verify the claim against the paragraph it came from. When there's no source, it says so. You're not asked to trust the model's memory; you're shown the evidence. For high-stakes decisions, "here's why" beats "trust me" every time — and it runs entirely on your hardware.
**CTA:** Read the Guide
**Hashtags:** #AIsafety #Grounding #Hallucination #CompanyBrain #OnPremAI
**Image suggestion:** A fluent answer with a verify-the-source magnifier over the citation.
**Carousel suggestion:** 5 slides — (1) Fluent-and-wrong is the danger, (2) Where general models fail, (3) Grounded by construction, (4) Verify against the paragraph, (5) "Here's why" > "trust me."
**Video suggestion:** 40s: hovering a citation to reveal the exact source paragraph behind an answer.
...
**Carousel suggestion:** 5 slayt — (1) Akıcı-ve-yanlış tehlike, (2) Genel modeller nerede hata yapar, (3) Yapısıyla dayanaklı, (4) Paragrafla doğrula, (5) "İşte nedeni" > "bana güven".
**Video suggestion:** 40s: bir atıfın üzerine gelince cevabın arkasındaki tam kaynak paragrafın belirmesi.

---

## Week 26 · Post 2 (Knowledge)
...
**Body:** Kıdemli kişiler haftalarının şaşırtıcı bir bölümünü, zaten yanıtlanmış soruları yanıtlamaya harcar — geçen ay, geçen yıl, başka bir sahada. Bu tekrar eden erişim görünmez bir maliyettir: sorgu servisi olarak harcanan uzman zamanı. Company Brain cevabı bir kez yakalar ve yeniden kullanılabilir kılar: atıflı, tutarlı, yetki bazlı, ona yetkili herkese açık. Uzman bir kez yanıtlar; kurum cevabı saklar. Bunu departmanlar ve sahalar boyunca çarpın, tasarruf gerçektir — insanları değiştirmekten değil, yalnızca onların yapabileceği işi yapmaları için serbest bırakmaktan. Bilgi yeniden yayımlanmayı bırakır ve sahip olduğunuz altyapıda birikmeye başlar.
**CTA:** ROI'nizi Hesaplayın
**Hashtags:** #BilgiYönetimi #Verimlilik #CompanyBrain #BilgininKorunması #KurumsalYapayZeka
**Image suggestion:** Bir kez yakalanan tek bir cevabın birçok talep edene yayılması.
**Carousel suggestion:** 5 slayt — (1) Yeniden yanıtlama vergisi, (2) Sorgu servisi olarak uzmanlar, (3) Bir kez yakala, yeniden kullan, (4) Gerçek işe serbest, (5) Bilgi birikir.
**Video suggestion:** 35s: bir uzman bir kez yanıtlar; aynı atıflı cevap sonraki beş talebe hizmet eder.

---

## Week 26 · Post 3 (Enterprise)

**EN**
**Hook:** "Buying AI is a committee decision. AdOS is built to satisfy the whole table."
**Body:** No single person signs off on enterprise AI. The CEO wants ROI. The CIO wants supportability. The CTO wants architecture and model choice. The CISO wants zero data leakage and an audit trail. HR wants adoption and knowledge retention. AdOS answers each without contradicting the others: sovereign for the CISO, operable for the CIO, portable and OpenAI-compatible for the CTO, unmetered and outcome-driven for the CEO, day-one useful for HR. One system, one set of facts, one boundary — no promise made to one stakeholder that quietly breaks another's requirement. That coherence is what gets a committee to yes.
**CTA:** Request a Demo
**Hashtags:** #EnterpriseAI #BuyingCommittee #CISO #CIO #OnPremAI
**Image suggestion:** A boardroom table with each seat labeled by concern, all pointing to one platform.
**Carousel suggestion:** 6 slides — (1) It's a committee, (2) CEO: ROI, (3) CIO/CTO: run it, own the model, (4) CISO: no leakage, audited, (5) HR: adoption, retention, (6) One coherent system.
**Video suggestion:** 45s: each stakeholder's question answered by the same platform, one at a time.
...
**Carousel suggestion:** 6 slayt — (1) Bu bir komite, (2) CEO: ROI, (3) CIO/CTO: çalıştır, modele sahip ol, (4) CISO: sızıntı yok, denetimli, (5) İK: benimseme, koruma, (6) Tek tutarlı sistem.
**Video suggestion:** 45s: her paydaşın sorusunun aynı platformca teker teker yanıtlanması.

---
## Week 27 · Post 1 (Educational)

**EN**
Hook: "Where does your AI send your factory floor's data?"
Body: Most enterprise AI answers arrive from someone else's cloud. That means your process notes, defect logs, and supplier terms travel off-site to be read. AdOS takes the opposite route. It runs Local AI on your own hardware — Ollama or any OpenAI-compatible engine — so inference happens inside your building. No cloud, no external API, no keys, no internet required. For Manufacturing teams protecting tacit know-how across sites, that difference is the whole point: the model works for you without your knowledge ever leaving the premises. Same capability, none of the exposure. Sovereignty is not a setting you toggle later; it is the architecture from the first byte.
CTA: Read the Guide
Hashtags: #SovereignAI #OnPremAI #Manufacturing #LocalLLM #DataSovereignty #EnterpriseAI
Image suggestion: Abstract factory building with a solid boundary wall, data glyphs contained inside.
Carousel suggestion: 5 slides — "Cloud AI path" vs "AdOS path," each stage of data movement compared.
Video suggestion: 30s screen capture of a query answered with no network connection, terminal showing no outbound traffic.

**TR**
Hook: "Yapay zekanız üretim sahanızın verisini nereye gönderiyor?"
Body: Çoğu kurumsal yapay zeka yanıtı başkasının bulutundan gelir. Bu, süreç notlarınızın, hata kayıtlarınızın ve tedarikçi şartlarınızın okunmak üzere dışarı çıkması demektir. AdOS tam tersini yapar. Local AI'yi kendi donanımınızda çalıştırır — Ollama ya da OpenAI uyumlu herhangi bir motor — böylece çıkarım binanızın içinde gerçekleşir. Bulut yok, harici API yok, anahtar yok, internet gerekmez. Sahalar arası örtük bilgisini koruyan Manufacturing ekipleri için fark budur: model sizin için çalışır, bilginiz binadan hiç çıkmaz. Aynı yetenek, sıfır maruziyet. Egemenlik sonradan açtığınız bir ayar değil; ilk bayttan itibaren mimarinin kendisidir.
CTA: Rehberi Okuyun
Hashtags: #EgemenYapayZeka #OnPremAI #Manufacturing #LocalLLM #VeriEgemenligi #EnterpriseAI
Image suggestion: Sınır duvarı olan soyut fabrika binası, veri işaretleri içeride tutulmuş.
Carousel suggestion: 5 slayt — "Bulut AI yolu" ile "AdOS yolu," her veri hareketi aşaması karşılaştırılır.
Video suggestion: 30sn ağ bağlantısı olmadan yanıtlanan sorgu, dışarı trafik olmadığını gösteren terminal.

---

## Week 27 · Post 2 (Industry insight)

**EN**
Hook: "Data-residency rules are no longer a legal footnote. They are the architecture decision."
Body: Across Municipalities and public institutions, residency is a mandate, not a preference. That single fact quietly disqualifies most AI purchasing shortlists before a demo is even booked, because public-cloud assistants move data off-site by design. The market is splitting in two: AI you rent in someone's cloud, and AI you own inside your walls. AdOS was built for the second category — an enterprise AI operating system that runs 100% on your infrastructure, offline-capable, fully auditable. When the compliance question arrives, the honest answer should already be built in, not bolted on. Sovereignty is becoming a procurement filter, and the filter is getting stricter.
CTA: Talk to Sales
Hashtags: #DataResidency #PublicSector #GovTech #SovereignAI #Compliance #OnPremAI
Image suggestion: Government building silhouette with a clear internal boundary line.
Carousel suggestion: 4 slides — the two AI categories, why residency splits them, where public sector lands.
Video suggestion: 40s explainer with a simple map showing data staying within a national/organizational boundary.

**TR**
Hook: "Veri ikametgahı kuralları artık hukuki bir dipnot değil. Mimari kararın kendisi."
Body: Belediyeler ve kamu kurumları genelinde ikametgah bir tercih değil, zorunluluktur. Bu tek gerçek, çoğu yapay zeka alım listesini demo bile ayarlanmadan sessizce eler; çünkü bulut asistanları veriyi tasarım gereği dışarı taşır. Pazar ikiye ayrılıyor: birinin bulutunda kiraladığınız yapay zeka ve duvarlarınızın içinde sahip olduğunuz yapay zeka. AdOS ikinci kategori için kuruldu — altyapınızda %100 çalışan, çevrimdışı yetenekli, tam denetlenebilir bir kurumsal yapay zeka işletim sistemi. Uyum sorusu geldiğinde dürüst yanıt sonradan eklenmiş değil, en baştan içeride olmalı. Egemenlik bir satın alma filtresine dönüşüyor ve filtre giderek sıkılaşıyor.
CTA: Satışla Görüşün
Hashtags: #VeriIkametgahi #KamuSektoru #GovTech #EgemenYapayZeka #Uyum #OnPremAI
Image suggestion: Net iç sınır çizgisi olan kamu binası silueti.
Carousel suggestion: 4 slayt — iki yapay zeka kategorisi, ikametgahın onları neden ayırdığı, kamunun nerede durduğu.
Video suggestion: 40sn açıklayıcı, verinin ulusal/kurumsal sınır içinde kaldığını gösteren basit bir harita.

---

## Week 27 · Post 3 (Product)
...
## Week 28 · Post 1 (Behind the scenes)
...
Carousel suggestion: 4 slides — connected answer, unplug, offline answer, same citations shown side by side.
Video suggestion: 60s single-take: ask, unplug on camera, ask again, answer appears with citations.
...
Carousel suggestion: 4 slayt — bağlıyken yanıt, fişi çek, çevrimdışı yanıt, aynı atıflar yan yana.
Video suggestion: 60sn tek çekim: sor, kamerada fişi çek, tekrar sor, yanıt atıflarla belirir.

---

## Week 28 · Post 2 (Customer story — ILLUSTRATIVE)
...
## Week 28 · Post 3 (Founder perspective)

**EN**
Hook: "I stopped believing 'trust us with your data' the day I read the retention clause."
Body: Every cloud AI contract asks for the same thing: send us your knowledge, we'll be careful. I kept asking the harder question — why should being careful be someone else's job? The buyers I respect most are skeptical, and they're right to be. So we built AdOS to remove the ask entirely. Your data never leaves the building. The model runs on your hardware. There is no telemetry of business content, no per-token bill, no lock-in. That's not a stricter promise; it's the absence of one you'd have to trust. I'd rather hand you control than ask for your faith. Sovereignty is the honest default.
CTA: Talk to Sales
Hashtags: #FounderPOV #SovereignAI #DataSovereignty #OnPremAI #EnterpriseAI #Leadership
Image suggestion: Plain quote card, founder line in large type on dark canvas.
Carousel suggestion: 3 slides — the ask, the harder question, the design answer.
Video suggestion: 45s talking-head, founder stating the principle to camera, no slides.

**TR**
Hook: "'Verinize biz göz kulak oluruz' cümlesine, saklama maddesini okuduğum gün inanmayı bıraktım."
Body: Her bulut yapay zeka sözleşmesi aynı şeyi ister: bilginizi bize gönderin, dikkatli oluruz. Ben daha zor soruyu sordum — dikkatli olmak neden başkasının işi olsun? En çok saygı duyduğum alıcılar şüphecidir ve haklıdırlar. Bu yüzden AdOS'u bu talebi tamamen ortadan kaldıracak şekilde kurduk. Veriniz binadan hiç çıkmaz. Model donanımınızda çalışır. İş içeriğinin telemetrisi yok, token başına fatura yok, kilitlenme yok. Bu daha katı bir söz değil; güvenmek zorunda kalacağınız sözün yokluğudur. Size inancınızı sormaktansa kontrolü vermeyi tercih ederim. Egemenlik dürüst olan varsayılandır.
CTA: Satışla Görüşün
Hashtags: #KurucuBakisi #EgemenYapayZeka #VeriEgemenligi #OnPremAI #EnterpriseAI #Liderlik
Image suggestion: Sade alıntı kartı, kurucu cümlesi koyu zeminde büyük puntoyla.
Carousel suggestion: 3 slayt — talep, daha zor soru, tasarım yanıtı.
Video suggestion: 45sn konuşan kafa, kurucu ilkeyi kameraya söylüyor, slayt yok.
...
**EN**
Hook: "'Faster' is not the only axis. Sometimes 'here, and provable' beats 'somewhere, and instant.'"
Body: Let's be honest about the trade-off. Local CPU inference is slower than a hosted frontier API — seconds, not milliseconds. AdOS states that plainly, and better hardware closes the gap. But speed is one axis; here is another: with Local AI, the model runs on your own machine, so your prompts and answers never leave your premises. For a Finance or Healthcare buyer, a two-second answer you fully own beats a 200-millisecond answer that left the building. Choose your constraint deliberately. We won't pretend local is faster than it is — we'll show you why "on your terms" is often the constraint that actually matters.
CTA: See the Platform
Hashtags: #LocalLLM #AITradeoffs #Inference #SovereignAI #Finance #Healthcare
Image suggestion: Two-axis chart, "speed" vs "sovereignty," AdOS positioned honestly.
Carousel suggestion: 5 slides — the honest trade-off, what closes the gap, why sovereignty wins for regulated buyers.
Video suggestion: 40s side-by-side latency clip with a caption conceding the millisecond gap.

**TR**
Hook: "'Daha hızlı' tek eksen değil. Bazen 'burada ve kanıtlanabilir', 'bir yerde ve anında'yı yener."
Body: Ödünleşme konusunda dürüst olalım. Yerel CPU çıkarımı, barındırılan bir frontier API'den yavaştır — milisaniye değil, saniye. AdOS bunu açıkça söyler ve daha iyi donanım farkı kapatır. Ama hız bir eksendir; işte bir başkası: Local AI ile model kendi makinenizde çalışır, böylece istemleriniz ve yanıtlarınız binadan çıkmaz. Bir Finance ya da Healthcare alıcısı için, tamamen sizin olan iki saniyelik yanıt, binadan çıkmış 200 milisaniyelik yanıttan iyidir. Kısıtınızı bilinçli seçin. Yerelin olduğundan hızlı olduğunu iddia etmeyiz — "kendi şartlarınızda"nın çoğu zaman asıl önemli kısıt olduğunu gösteririz.
CTA: Platformu Keşfedin
Hashtags: #LocalLLM #YapayZekaOdunlesmeleri #Cikarim #EgemenYapayZeka #Finance #Healthcare
Image suggestion: İki eksenli grafik, "hız" ile "egemenlik," AdOS dürüstçe konumlanmış.
Carousel suggestion: 5 slayt — dürüst ödünleşme, farkı ne kapatır, egemenlik regüle alıcıda neden kazanır.
Video suggestion: 40sn yan yana gecikme klibi, milisaniye farkını kabul eden altyazı.

---

## Week 29 · Post 2 (Knowledge)
...
Carousel suggestion: 5 slayt — emeklilik sorunu, dağınık kaynaklar, Company Brain, atıflı yanıt, korunum sonucu.
Video suggestion: 50sn anlatımlı animasyon, kurumsal bilginin çıkıştan önce yakalanması.

---

## Week 29 · Post 3 (Enterprise)
...
Carousel suggestion: 5 slides — the OSB opportunity, tenant isolation, per-firm Company Brain, shared operation, member value.
Video suggestion: 45s diagram animation of isolated tenants under one on-prem platform.
...
Carousel suggestion: 5 slayt — OSB fırsatı, kiracı yalıtımı, firma başına Company Brain, ortak işletim, üye değeri.
Video suggestion: 45sn diyagram animasyonu, tek on-prem platform altında yalıtılmış kiracılar.

---

## Week 30 · Post 1 (Security)

**EN**
Hook: "The most secure API call is the one your AI never makes."
Body: Security teams spend enormous effort controlling what leaves the network. Cloud AI reopens that door by design — every prompt and document is an outbound flow to someone else's servers. AdOS closes it. Local AI means inference runs on your hardware; there is no external API, no API keys to leak, no internet dependency. Business content produces no telemetry. The attack surface you don't have is the one you never defend. For a CISO, that's not a smaller risk to manage — it's a category of exposure that simply isn't present. Sober point, precisely stated: you can't intercept a call that was never placed.
CTA: See the Platform
Hashtags: #CISO #DataSecurity #ZeroLeakage #SovereignAI #OnPremAI #InfoSec
Image suggestion: A network boundary with a greyed-out, unused outbound port.
Carousel suggestion: 5 slides — the outbound-flow problem, no external API, no keys, no telemetry, the absent attack surface.
Video suggestion: 40s sober narration over a diagram showing zero outbound AI traffic.

**TR**
Hook: "En güvenli API çağrısı, yapay zekanızın hiç yapmadığıdır."
Body: Güvenlik ekipleri ağdan neyin çıktığını kontrol etmek için büyük çaba harcar. Bulut yapay zeka bu kapıyı tasarım gereği yeniden açar — her istem ve belge, başkasının sunucusuna giden dışa akıştır. AdOS onu kapatır. Local AI, çıkarımın donanımınızda çalışması demektir; harici API yok, sızacak API anahtarı yok, internet bağımlılığı yok. İş içeriği telemetri üretmez. Sahip olmadığınız saldırı yüzeyi, hiç savunmadığınızdır. Bir CISO için bu, yönetilecek daha küçük bir risk değil — hiç var olmayan bir maruziyet kategorisidir. Sakin ve kesin: hiç yapılmamış bir çağrıyı dinleyemezsiniz.
CTA: Platformu Keşfedin
Hashtags: #CISO #VeriGuvenligi #SifirSizinti #EgemenYapayZeka #OnPremAI #InfoSec
Image suggestion: Kullanılmayan, gri bir dışa çıkış portu olan ağ sınırı.
Carousel suggestion: 5 slayt — dışa akış sorunu, harici API yok, anahtar yok, telemetri yok, olmayan saldırı yüzeyi.
Video suggestion: 40sn sakin anlatım, sıfır dışa yapay zeka trafiği gösteren diyagram.
...
## Week 30 · Post 3 (Industry insight)

**EN**
Hook: "Retail's real AI cost isn't the license. It's the query volume you'll be billed for."
Body: Distributed retail teams ask thousands of questions a day — policy, product, returns, scheduling. On a per-token cloud model, that volume becomes a meter that never stops running, and the bill grows with adoption. AdOS breaks the link. Inference runs on your own hardware, so there's no per-token billing at all; your cost is electricity and the box, not each query. Ask ten thousand questions or a hundred thousand — the pricing doesn't punish success. For a Retail CFO, that turns AI from a variable, adoption-penalizing expense into a fixed, ownable asset. When usage is free at the margin, you actually let people use it.
CTA: Calculate Your ROI
Hashtags: #Retail #NoPerTokenBilling #TCO #SovereignAI #OnPremAI #EnterpriseAI
Image suggestion: A meter that has been switched off, beside a fixed-cost server.
Carousel suggestion: 5 slides — the metered-cost trap, adoption penalty, local inference, fixed cost, ROI framing.
Video suggestion: 40s animation of a spinning meter stopping when workload moves on-prem.

**TR**
Hook: "Retail'in gerçek yapay zeka maliyeti lisans değil. Faturalanacağınız sorgu hacmi."
Body: Dağıtık perakende ekipleri günde binlerce soru sorar — politika, ürün, iade, planlama. Token başına bulut modelinde bu hacim hiç durmayan bir sayaca dönüşür ve fatura benimsemeyle büyür. AdOS bu bağı koparır. Çıkarım kendi donanımınızda çalışır, yani token başına faturalama hiç yoktur; maliyetiniz elektrik ve kutudur, her sorgu değil. On bin soru sorun ya da yüz bin — fiyatlandırma başarıyı cezalandırmaz. Bir Retail CFO'su için bu, yapay zekayı değişken ve benimsemeyi cezalandıran bir giderden, sabit ve sahip olunabilir bir varlığa dönüştürür. Kullanım marjda ücretsizse, insanların gerçekten kullanmasına izin verirsiniz.
CTA: ROI'nizi Hesaplayın
Hashtags: #Retail #TokenBasinaFaturaYok #TCO #EgemenYapayZeka #OnPremAI #EnterpriseAI
Image suggestion: Kapatılmış bir sayaç, sabit maliyetli bir sunucunun yanında.
Carousel suggestion: 5 slayt — sayaçlı maliyet tuzağı, benimseme cezası, yerel çıkarım, sabit maliyet, ROI çerçevesi.
Video suggestion: 40sn animasyon, iş yükü on-prem'e geçince dönen sayacın durması.

---

## Week 31 · Post 1 (Product)
...
## Week 31 · Post 2 (Behind the scenes)

**EN**
Hook: "We ship one command to bring the whole thing up. That took a lot of unglamorous work."
Body: AdOS deploys with standard Docker and a one-command bring-up — which sounds simple and isn't. Behind that line sit documented runbooks for backup, restore, upgrade, and disaster recovery, because day-2 is where enterprise software actually lives. We'd rather an IT/BT team never wonder "what happens when the disk fills, or the box dies, or we need to roll back a version." The boring parts — the runbooks, the restore drills — are the parts that earn trust with a CIO evaluating supportability. Version 1.0.0 shipped with those runbooks written, not promised. Reliable is a feature, and it's mostly built out of preparation.
CTA: See the Platform
Hashtags: #DevOps #Docker #DisasterRecovery #ITOps #EnterpriseAI #OnPremAI
Image suggestion: A terminal showing one bring-up command, runbook tabs stacked behind it.
Carousel suggestion: 5 slides — one-command bring-up, backup, restore, upgrade, DR runbook.
Video suggestion: 50s screen recording of the bring-up command followed by a restore drill.

**TR**
Hook: "Her şeyi ayağa kaldıran tek komut sunuyoruz. Bu, gösterişsiz çok emek istedi."
Body: AdOS standart Docker ve tek komutla ayağa kalkar — kulağa basit gelir, değildir. O satırın arkasında yedekleme, geri yükleme, yükseltme ve felaket kurtarma için belgelenmiş runbook'lar durur; çünkü kurumsal yazılım asıl day-2'de yaşar. Bir IT/BT ekibinin "disk dolunca, kutu ölünce ya da sürümü geri almamız gerekince ne olacak" diye hiç merak etmemesini tercih ederiz. Sıkıcı kısımlar — runbook'lar, geri yükleme tatbikatları — desteklenebilirliği değerlendiren bir CIO'nun güvenini kazanan kısımlardır. Version 1.0.0, bu runbook'lar vaat edilmiş değil yazılmış olarak çıktı. Güvenilirlik bir özelliktir ve çoğunlukla hazırlıktan yapılır.
CTA: Platformu Keşfedin
Hashtags: #DevOps #Docker #FelaketKurtarma #ITOps #EnterpriseAI #OnPremAI
Image suggestion: Tek ayağa kaldırma komutunu gösteren terminal, arkasında runbook sekmeleri.
Carousel suggestion: 5 slayt — tek komut ayağa kaldırma, yedekleme, geri yükleme, yükseltme, DR runbook.
Video suggestion: 50sn ekran kaydı, ayağa kaldırma komutu ardından geri yükleme tatbikatı.

---

## Week 31 · Post 3 (Customer story — ILLUSTRATIVE)
...
## Week 32 · Post 1 (Founder perspective)
...
**EN**
Hook: "You don't have to be locked into one model to get one answer."
Body: Vendor lock-in is the quiet tax of most AI platforms — one provider, one model, one contract you can't leave. AdOS is built the other way. It runs on open engines through an OpenAI-compatible interface: Ollama, vLLM, LM Studio, llama.cpp, SGLang. Your CTO chooses the model, swaps it when a better one lands, and keeps data portable and exportable throughout. No API keys tether you to a single cloud. That's not just flexibility; it's insurance against a market moving fast. When the frontier shifts — and it will — you change the engine, not the platform. Owning the stack means owning the choice.
CTA: See the Platform
Hashtags: #NoVendorLockIn #LocalLLM #Ollama #vLLM #CTO #SovereignAI
Image suggestion: A socket labeled "OpenAI-compatible" with several interchangeable model plugs.
Carousel suggestion: 5 slides — the lock-in tax, open engines, model choice, portable data, future-proofing.
Video suggestion: 40s clip swapping the underlying model with the same interface unchanged.

**TR**
Hook: "Tek bir yanıt almak için tek bir modele kilitlenmek zorunda değilsiniz."
Body: Satıcı kilitlenmesi çoğu yapay zeka platformunun sessiz vergisidir — tek sağlayıcı, tek model, terk edemeyeceğiniz tek sözleşme. AdOS tam tersi kurulu. Açık motorlarda, OpenAI uyumlu bir arayüzle çalışır: Ollama, vLLM, LM Studio, llama.cpp, SGLang. CTO'nuz modeli seçer, daha iyisi çıktığında değiştirir ve boyunca veriyi taşınabilir ve dışa aktarılabilir tutar. Hiçbir API anahtarı sizi tek buluta bağlamaz. Bu yalnızca esneklik değil; hızlı hareket eden bir pazara karşı sigortadır. Sınır kaydığında — ki kayacak — platformu değil motoru değiştirirsiniz. Yığına sahip olmak, seçime sahip olmaktır.
CTA: Platformu Keşfedin
Hashtags: #SaticiKilitlenmesiYok #LocalLLM #Ollama #vLLM #CTO #EgemenYapayZeka
Image suggestion: "OpenAI uyumlu" etiketli bir soket, birkaç değiştirilebilir model fişi.
Carousel suggestion: 5 slayt — kilitlenme vergisi, açık motorlar, model seçimi, taşınabilir veri, geleceğe hazırlık.
Video suggestion: 40sn klip, alttaki modelin arayüz değişmeden değiştirilmesi.

---

## Week 32 · Post 3 (Knowledge)
...
Carousel suggestion: 5 slayt — parçalanma, üç çözüm sorunu, sahaya dayalı yanıtlar, yalıtım, tutarlılık.
Video suggestion: 45sn animasyon, dağınık saha bilgisinin tutarlı atıflı yanıtlara çözülmesi.

---

## Week 33 · Post 2 (Security)
...
## Week 33 · Post 3 (Educational)

**EN**
Hook: "'On-premise' and 'private cloud' are not the same promise. Know which you're buying."
Body: Plenty of 'private AI' actually means a walled section of someone else's cloud — better, but your data still lives on hardware you don't own. On-premise means the software and the data run on your machines, inside your building. AdOS supports both your on-premise servers and your own private cloud/VPC — the constant is that you own the entire stack: app, data, and model. That distinction decides who can subpoena, inspect, or bill your information. For a CIO writing a data-residency policy, the wording on the contract is the whole ballgame. Ask the precise question: whose hardware, whose building, whose keys? The answer should be "ours" on all three.
CTA: Read the Guide
Hashtags: #OnPremAI #PrivateCloud #DataSovereignty #CIO #EnterpriseAI #SovereignAI
Image suggestion: Two buildings side by side — "someone else's cloud" vs "your premises."
Carousel suggestion: 6 slides — the terminology trap, on-prem defined, private cloud/VPC, own the stack, the three questions, the right answer.
Video suggestion: 45s explainer contrasting hardware ownership across deployment models.

**TR**
Hook: "'On-premise' ile 'özel bulut' aynı söz değildir. Hangisini aldığınızı bilin."
Body: Pek çok 'özel yapay zeka' aslında başkasının bulutunun duvarlı bir bölümü demektir — daha iyi, ama veriniz yine sahip olmadığınız donanımda yaşar. On-premise, yazılımın ve verinin kendi makinelerinizde, binanızın içinde çalışması demektir. AdOS hem on-premise sunucularınızı hem de kendi özel bulut/VPC'nizi destekler — değişmeyen şey tüm yığına sahip olmanızdır: uygulama, veri ve model. Bu ayrım bilginizi kimin celp edebileceğini, inceleyebileceğini ya da faturalayabileceğini belirler. Veri ikametgahı politikası yazan bir CIO için sözleşmedeki ifade her şeydir. Kesin soruyu sorun: kimin donanımı, kimin binası, kimin anahtarı? Yanıt üçünde de "bizim" olmalı.
CTA: Rehberi Okuyun
Hashtags: #OnPremAI #OzelBulut #VeriEgemenligi #CIO #EnterpriseAI #EgemenYapayZeka
Image suggestion: Yan yana iki bina — "başkasının bulutu" ile "sizin binanız."
Carousel suggestion: 6 slayt — terminoloji tuzağı, on-prem tanımı, özel bulut/VPC, yığına sahiplik, üç soru, doğru yanıt.
Video suggestion: 45sn açıklayıcı, dağıtım modelleri arasında donanım sahipliğini karşılaştırma.

---

## Week 34 · Post 1 (Industry insight)
...
## Week 34 · Post 3 (Behind the scenes)
...
Carousel suggestion: 5 slayt — otomatik dil algılama, iddia denklik kuralı, yerel TR, İngilizce ürün terimleri, çift onay.
Video suggestion: 40sn arayüzün canlı TR/EN geçişi, iki dilde aynı atıflı yanıt.

---

## Week 35 · Post 1 (Customer story — ILLUSTRATIVE)
...
## Week 35 · Post 2 (Founder perspective)
...
Carousel suggestion: 4 slides — the boring compliment, exciting where it counts, calm where it matters, honest trade-offs.
Video suggestion: 45s founder to camera on why calm beats flashy in enterprise software.
...
Carousel suggestion: 4 slayt — sıkıcı iltifat, önemli yerde heyecan, gereken yerde sakinlik, dürüst ödünleşmeler.
Video suggestion: 45sn kurucu kameraya, kurumsal yazılımda sakinliğin gösterişi neden yendiği.
...
**TR**
Hook: "Logistics'te yeni birini işe alıştırmak eskiden iki hafta soruşturmak demekti."
Body: Yüksek hacimli, zaman-kritik operasyonlarda bir kişinin bilmemesinin maliyeti yalnızca eğitim saatiyle değil gecikmeyle ölçülür. Company Brain bu eğriyi kısaltır. Yeni bir sevk görevlisi sade bir soru sorar — bu istisnayı nasıl ele alırız, bu hat için hangi taşıyıcı — ve şirketin kendi onaylı prosedürlerinden, rolüne göre kapsamlı, atıflı bir yanıt alır. Kıdemli bir meslektaşı rahatsız etmek yok, tahmin yok, eski PDF yok. Bir HR ya da Operations lideri için hareket eden metrik ilk-faydalı-yanıta-kadar-geçen-süredir. Eskiden birkaç kafada yaşayan kurumsal hafıza artık ilk gün yanıt verir. Daha hızlı işe alıştırma daha zeki insanlarla değil, bulunabilir bilgiyle ilgilidir.
CTA: Rehberi Okuyun
Hashtags: #Logistics #Oryantasyon #BilgiYonetimi #CompanyBrain #HR #EgemenYapayZeka
Image suggestion: İlk gün ekranında atıflı yanıt alan yeni bir çalışanın olduğu sevkiyat masası.
Carousel suggestion: 5 slayt — iki hafta sorunu, sade soru, atıflı prosedür, rol kapsamı, ilk gün verimliliği.
Video suggestion: 45sn yeni sevk görevlisinin atıflı Company Brain yanıtıyla istisnayı çözmesi.

---

## Week 36 · Post 2 (Enterprise)

**EN**
Hook: "Total cost of ownership is where cloud AI quietly loses the enterprise deal."
Body: The sticker looks cheap until you add the meter. Public-cloud AI bills per token, so every additional user, query, and document scanned raises the run-rate — and the number you can't forecast is the one Finance hates most. AdOS changes the shape of the cost. You own the stack, inference runs on your hardware, and there's no per-token or per-query metering; the marginal cost of a question is electricity. Licensing is value-based — platform plus support — not a usage tax on adoption. For a CIO modeling TCO across thousands of seats, predictable and ownable beats cheap-then-climbing. The cost that scales with your success shouldn't be the one you're afraid to grow.
CTA: Calculate Your ROI
Hashtags: #TCO #EnterpriseAI #NoPerTokenBilling #CIO #Finance #SovereignAI
Image suggestion: A flat cost line vs a climbing metered line over adoption growth.
Carousel suggestion: 6 slides — the cheap sticker, the meter, own the stack, no per-token, value-based license, predictable TCO.
Video suggestion: 45s animated cost curves diverging as usage scales.

**TR**
Hook: "Toplam sahip olma maliyeti, bulut yapay zekanın kurumsal anlaşmayı sessizce kaybettiği yerdir."
Body: Etiket ucuz görünür, ta ki sayacı ekleyene kadar. Bulut yapay zeka token başına faturalar, yani her ek kullanıcı, sorgu ve taranan belge işletme maliyetini yükseltir — ve öngöremediğiniz sayı, Finance'in en nefret ettiğidir. AdOS maliyetin şeklini değiştirir. Yığına sahip olursunuz, çıkarım donanımınızda çalışır ve token ya da sorgu başına ölçüm yoktur; bir sorunun marjinal maliyeti elektriktir. Lisanslama değer temellidir — platform artı destek — benimseme üzerine bir kullanım vergisi değil. Binlerce koltuk boyunca TCO modelleyen bir CIO için öngörülebilir ve sahip olunabilir, ucuz-sonra-tırmanan'ı yener. Başarınızla ölçeklenen maliyet, büyütmekten korktuğunuz olmamalı.
CTA: ROI'nizi Hesaplayın
Hashtags: #TCO #EnterpriseAI #TokenBasinaFaturaYok #CIO #Finance #EgemenYapayZeka
Image suggestion: Benimseme büyürken düz maliyet çizgisi ile tırmanan sayaçlı çizgi.
Carousel suggestion: 6 slayt — ucuz etiket, sayaç, yığına sahiplik, token başına yok, değer temelli lisans, öngörülebilir TCO.
Video suggestion: 45sn kullanım ölçeklenirken ayrışan animasyonlu maliyet eğrileri.

**TR**

---

## Week 36 · Post 3 (Security)
...
Carousel suggestion: 5 slides — air-gapped realities, cloud AI can't operate, offline-first design, live disconnect proof, boundary by design.
Video suggestion: 50s air-gap demo: full workflow completed with the network physically disconnected.
...
Carousel suggestion: 5 slayt — air-gap gerçekleri, bulut AI çalışamaz, çevrimdışı-öncelikli tasarım, canlı kesme kanıtı, tasarımla sınır.
Video suggestion: 50sn air-gap demosu: ağ fiziksel kesikken tamamlanan tam workflow.

---

## Week 37 · Post 1 (Educational)
...
Carousel suggestion: 5 slayt — birinci soru (çıkarım nerede), ikinci soru (atıflı + kapsamlı), üçüncü soru (air-gap), AdOS nasıl yanıtlar, sahiplik tanımı.
Video suggestion: 40sn kameraya üç soruyu sorma, ekranda metin.
...
Carousel suggestion: 5 slayt — büyük arşiv küçük bütçe, on-prem laboratuvarlar, token başına yok, atıflı yanıtlar, sabit sahip olunabilir maliyet.
Video suggestion: 45sn üniversite arşivinin yerel donanımda aranabilir atıflı yanıtlara dönüşmesi.

---

## Week 37 · Post 3 (Product)
...
## Week 38 · Post 1 (Behind the scenes)
...
## Week 38 · Post 2 (Customer story — ILLUSTRATIVE)
...
Carousel suggestion: 6 slayt — dağıtık perakende, sürekli sorular, yerel atıflı yanıtlar, ölçümsüz kullanım, kiracı yalıtımı, "örnekleyici" notu.
Video suggestion: 50sn canlandırılmış mağaza sahnesi, kalıcı "Örnek senaryo" filigranı.

---

## Week 38 · Post 3 (Founder perspective)

**EN**
Hook: "I get asked why we're 'Turkey-first' as if it's a limitation. It's a design advantage."
Body: We built AdOS bilingual from the first line — native Turkish and English, same claims, same numbers, product terms kept English on purpose. That wasn't a localization afterthought; it shaped how we think. Building for a market where data residency is a mandate, not a preference, forced sovereignty to be real, not marketing. Turkey-first made us honest early. And what we learned serves any market where the rule is "the data stays here" — which is a growing list. Sovereignty is universal; we just started where it was non-negotiable. Building for the strict buyer first tends to produce something the relaxed buyer trusts too.
CTA: Talk to Sales
Hashtags: #FounderPOV #TurkeyFirst #DataResidency #SovereignAI #Bilingual #EnterpriseAI
Image suggestion: A plain quote card, "Turkey-first, sovereignty-universal," on dark canvas.
Carousel suggestion: 4 slides — the limitation question, bilingual from line one, residency as a forcing function, sovereignty universal.
Video suggestion: 45s founder to camera on why building for the strictest buyer helps everyone.

**TR**
Hook: "Neden 'Türkiye-öncelikli' olduğumuz, bir sınırlamaymış gibi soruluyor. Bir tasarım avantajı."
Body: AdOS'u ilk satırdan iki dilli kurduk — yerel Türkçe ve İngilizce, aynı iddialar, aynı sayılar, ürün terimleri bilerek İngilizce. Bu sonradan eklenen bir yerelleştirme değildi; nasıl düşündüğümüzü şekillendirdi. Veri ikametgahının bir tercih değil zorunluluk olduğu bir pazar için kurmak, egemenliği pazarlama değil gerçek olmaya zorladı. Türkiye-öncelikli bizi erkenden dürüst yaptı. Ve öğrendiğimiz şey, kuralın "veri burada kalır" olduğu her pazara hizmet eder — ki bu büyüyen bir liste. Egemenlik evrenseldir; biz sadece pazarlığa kapalı olduğu yerden başladık. Önce katı alıcı için kurmak, rahat alıcının da güvendiği bir şey üretme eğilimindedir.
CTA: Satışla Görüşün
Hashtags: #KurucuBakisi #TurkiyeOncelikli #VeriIkametgahi #EgemenYapayZeka #IkiDilli #EnterpriseAI
Image suggestion: Koyu zeminde "Türkiye-öncelikli, egemenlik-evrensel" sade alıntı kartı.
Carousel suggestion: 4 slayt — sınırlama sorusu, ilk satırdan iki dilli, zorlayıcı işlev olarak ikametgah, evrensel egemenlik.
Video suggestion: 45sn kurucu kameraya, en katı alıcı için kurmanın neden herkese yaradığı.
...
**EN**
Hook: "The scary AI question in a boardroom isn't 'is it smart?' It's 'where did our data just go?'"
Body: Executives have made peace with capable models. What keeps a board awake is exposure — the quiet realization that using cloud AI means the company's knowledge now lives, at least in transit, on infrastructure it doesn't control. AdOS removes the question from the table. Local AI means inference runs on your own hardware; data sovereignty means business content never leaves the premises and produces no telemetry. The board-level one-liner is simple: sovereign AI is all the capability, none of the data leaving your building. Smart is table stakes now. Sovereign is the differentiator. Answer the exposure question before someone on the board asks it for you.
CTA: See the Platform
Hashtags: #SovereignAI #BoardroomAI #DataSovereignty #EnterpriseAI #CIO #OnPremAI
Image suggestion: A boardroom table with a building outline, data contained inside its walls.
Carousel suggestion: 5 slides — capability is settled, exposure isn't, local inference, no data leaves, the board one-liner.
Video suggestion: 40s to-camera framing the exposure question and its answer.

**TR**
Hook: "Yönetim kurulundaki korkutucu yapay zeka sorusu 'akıllı mı?' değil. 'Verimiz az önce nereye gitti?'"
Body: Yöneticiler yetenekli modellerle barıştı. Bir kurulu uyanık tutan maruziyettir — bulut yapay zeka kullanmanın, şirketin bilgisinin artık en azından aktarımda, kontrol etmediği bir altyapıda yaşadığı sessiz farkındalığı. AdOS soruyu masadan kaldırır. Local AI, çıkarımın kendi donanımınızda çalışması demektir; veri egemenliği, iş içeriğinin binadan hiç çıkmaması ve telemetri üretmemesi demektir. Kurul seviyesi tek cümle basittir: egemen yapay zeka, tüm yetenek, binadan çıkan hiç veri yok. Akıllı olmak artık asgari şart. Egemen olmak farklılaştırıcıdır. Maruziyet sorusunu, kuruldan biri sizin yerinize sormadan önce yanıtlayın.
CTA: Platformu Keşfedin
Hashtags: #EgemenYapayZeka #YonetimKuruluYapayZeka #VeriEgemenligi #EnterpriseAI #CIO #OnPremAI
Image suggestion: Duvarları içinde veri tutulan bina taslağı olan bir yönetim kurulu masası.
Carousel suggestion: 5 slayt — yetenek çözüldü, maruziyet çözülmedi, yerel çıkarım, veri çıkmaz, kurul tek cümlesi.
Video suggestion: 40sn kameraya maruziyet sorusunu ve yanıtını çerçeveleme.

---

## Week 39 · Post 2 (Knowledge)
...
Carousel suggestion: 5 slides — knowledge as asset, why it's lost, Company Brain grounding, cited + scoped, durable memory.
Video suggestion: 45s of scattered expertise consolidating into queryable institutional memory.
...
Carousel suggestion: 5 slayt — varlık olarak bilgi, neden kaybolur, Company Brain dayanağı, atıflı + kapsamlı, kalıcı hafıza.
Video suggestion: 45sn dağınık uzmanlığın sorgulanabilir kurumsal hafızaya birleşmesi.

---

## Week 39 · Post 3 (Enterprise)

**EN**
Hook: "The right question isn't 'build or buy AI?' It's 'which one leaves you owning the stack?'"
Body: Build-your-own means months of integration and a team you have to keep. Rent-from-the-cloud means fast start and permanent dependency — someone else's hardware, meter, and model. AdOS is a third answer: buy a complete enterprise AI operating system and still own the entire stack — app, data, and model — on your own infrastructure. It deploys with standard Docker and a one-command bring-up, ships documented backup, restore, upgrade, and DR runbooks, and runs on open, swappable engines with no lock-in. For a CIO weighing time-to-value against control, you don't have to trade one for the other. Buy the capability; keep the ownership. That's the option most vendors won't offer.
CTA: See the Platform
Hashtags: #BuildVsBuy #EnterpriseAI #OwnTheStack #NoVendorLockIn #CIO #SovereignAI
Image suggestion: Three paths — build, rent, own — converging on "own the stack" highlighted.
Carousel suggestion: 6 slides — build cost, rent dependency, the third answer, own the stack, easy deploy, no lock-in.
Video suggestion: 45s decision-tree animation landing on buy-and-own.

**TR**
Hook: "Doğru soru 'yapay zekayı kur mu al mı?' değil. 'Hangisi yığına sahip olmanızı sağlar?'"
Body: Kendin-kur, aylarca entegrasyon ve tutmanız gereken bir ekip demektir. Buluttan-kirala, hızlı başlangıç ve kalıcı bağımlılık demektir — başkasının donanımı, sayacı ve modeli. AdOS üçüncü bir yanıttır: eksiksiz bir kurumsal yapay zeka işletim sistemi satın alın ve yine tüm yığına — uygulama, veri ve model — kendi altyapınızda sahip olun. Standart Docker ve tek komutla ayağa kalkar, belgelenmiş yedekleme, geri yükleme, yükseltme ve DR runbook'larıyla gelir ve kilitlenme olmadan açık, değiştirilebilir motorlarda çalışır. Değer-süresini kontrole karşı tartan bir CIO için birini diğerine feda etmeniz gerekmez. Yeteneği satın alın; sahipliği koruyun. Bu, çoğu satıcının sunmayacağı seçenektir.
CTA: Platformu Keşfedin
Hashtags: #KurmaVsSatinAlma #EnterpriseAI #YiginaSahipOl #SaticiKilitlenmesiYok #CIO #EgemenYapayZeka
Image suggestion: Üç yol — kur, kirala, sahip ol — vurgulanmış "yığına sahip ol"da birleşiyor.
Carousel suggestion: 6 slayt — kurma maliyeti, kiralama bağımlılığı, üçüncü yanıt, yığına sahiplik, kolay dağıtım, kilitlenme yok.
Video suggestion: 45sn karar-ağacı animasyonu, satın-al-ve-sahip-ol'da sonlanır.
...
- **Carousel suggestion:** "5 questions your board will ask about AI data."
- **Video suggestion:** 30s whiteboard: cloud AI vs on-prem AI data paths.
...
- **Carousel suggestion:** "Yönetim kurulunuzun yapay zekâ verisi hakkında soracağı 5 soru."
- **Video suggestion:** 30 sn tahta: bulut yapay zekâ ile kurum içi yapay zekâ veri yolları.
...
- **Carousel suggestion:** "Why regulated sectors choose architecture over model."
- **Video suggestion:** 20s: three compliance officers, one requirement — data stays home.
...
- **Carousel suggestion:** "Düzenlemeye tabi sektörler neden modeli değil mimariyi seçiyor."
- **Video suggestion:** 20 sn: üç uyum sorumlusu, tek gereksinim — veri evde kalır.
...
- **Carousel suggestion:** "Attack surface: cloud AI vs AdOS."
- **Video suggestion:** 20s: unplug the network cable, the demo keeps answering.
...
- **Carousel suggestion:** "Saldırı yüzeyi: bulut yapay zekâ ile AdOS."
- **Video suggestion:** 20 sn: ağ kablosunu çek, demo yanıtlamaya devam ediyor.
...
- **Carousel suggestion:** "3 ways knowledge leaks — and how to plug them."
- **Video suggestion:** 25s: retirement handshake, new hire asks the Company Brain instead.
...
- **Carousel suggestion:** "Bilginin sızdığı 3 yol — ve nasıl kapatılır."
- **Video suggestion:** 25 sn: emeklilik tokalaşması, yeni çalışan bunun yerine Company Brain'e soruyor.
...
- **Carousel suggestion:** "Why we chose on-prem when the whole industry chose cloud."
- **Video suggestion:** 40s founder talking-head, no slides.

**TR**
- **Hook:** AdOS'u kurduk çünkü "verinizde bize güvenin" bir strateji değildir.
- **Body:** Tanıştığım her kurum yapay zekâ istiyor ve aynı şeyden korkuyordu: en hassas bilgisini bir başkasının bulutuna göndermek. Biz de tersine çevirdik. Veri olduğu yerde kalsın; yapay zekâyı ona getirelim. Kendi donanımınızda, çevrimdışı uyumlu, izin-farkında, sayaçsız. Egemenlik eklediğimiz bir özellik değil — AdOS'un var olma nedenidir.
- **CTA:** Satışla Görüşün
- **Hashtags:** #KurucuBakışı #EgemenYapayZeka #KurumsalYapayZeka #AçıkGeliştirme
- **Image suggestion:** Koyu arka planda düz metin alıntı kartı.
- **Carousel suggestion:** "Tüm sektör bulutu seçerken biz neden kurum içini seçtik."
- **Video suggestion:** 40 sn kurucu konuşan-kafa, slayt yok.

## Week 42 · Post 1 (Educational)
**EN**
- **Hook:** "Local LLM" sounds technical. The business case is simple.
- **Body:** Running the model on your own hardware means three things a metered cloud can't offer: your data never leaves, there's no per-token bill, and it works with no internet. The honest trade-off is speed — local inference answers in seconds, not milliseconds, and better hardware narrows the gap. For sensitive work, that trade is easy.
- **CTA:** Read the Guide
- **Hashtags:** #LocalLLM #OnPremAI #TCO #EnterpriseAI
- **Image suggestion:** Balance scale: "seconds of latency" vs "sovereignty + no metering."
- **Carousel suggestion:** "Local LLM in plain business terms."
- **Video suggestion:** 30s explainer on the local-vs-cloud trade-off.

**TR**
- **Hook:** "Yerel LLM" teknik geliyor. İş gerekçesi ise basit.
- **Body:** Modeli kendi donanımınızda çalıştırmak, sayaçlı bir bulutun sunamayacağı üç şey demektir: veriniz hiç çıkmaz, jeton başı fatura yoktur ve internetsiz çalışır. Dürüst ödünleşim hızdır — yerel çıkarım milisaniyelerde değil saniyelerde yanıtlar, daha iyi donanım farkı daraltır. Hassas işler için bu ödünleşim kolaydır.
- **CTA:** Rehberi Okuyun
- **Hashtags:** #YerelLLM #KurumİçiYapayZeka #ToplamMaliyet #KurumsalYapayZeka
- **Image suggestion:** Terazi: "saniyelik gecikme" ile "egemenlik + sayaçsızlık".
- **Carousel suggestion:** "Yerel LLM sade iş diliyle."
- **Video suggestion:** 30 sn yerel-bulut ödünleşimi anlatımı.

## Week 42 · Post 2 (Behind the scenes)
**EN**
- **Hook:** Our demo doesn't need Wi-Fi. On purpose.
- **Body:** When we show AdOS, we sometimes unplug the network mid-session. The Company Brain keeps answering, citations and all, because everything runs locally. It's the most honest way to prove "your data never leaves." No smoke, no mirrors, no cloud call in the background.
- **CTA:** Request a Demo
- **Hashtags:** #BehindTheScenes #AirGap #ProductDemo #OnPremAI
- **Image suggestion:** A laptop with an airplane-mode icon, demo running.
- **Carousel suggestion:** "What we do in every demo that competitors can't."
- **Video suggestion:** 20s: presenter toggles airplane mode, keeps demoing.

**TR**
- **Hook:** Demomuz Wi-Fi istemez. Bilerek.
- **Body:** AdOS'u gösterirken bazen oturum ortasında ağı çekeriz. Company Brain, alıntılarıyla birlikte yanıtlamaya devam eder; çünkü her şey yerelde çalışır. "Veriniz hiç çıkmaz"ı kanıtlamanın en dürüst yolu budur. Numara yok, arka planda bulut çağrısı yok.
- **CTA:** Demo Talep Edin
- **Hashtags:** #PerdeArkası #HavaBoşluğu #ÜrünDemosu #KurumİçiYapayZeka
- **Image suggestion:** Uçak modu simgeli bir dizüstü, demo çalışıyor.
- **Carousel suggestion:** "Her demoda yaptığımız, rakiplerin yapamadığı şey."
- **Video suggestion:** 20 sn: sunucu uçak modunu açar, demoya devam eder.
...
**EN**
- **Hook:** Per-token pricing quietly taxes every question your team asks.
- **Body:** Metered cloud AI means the more useful it becomes, the more it costs — a meter that punishes adoption. Local inference has no per-token bill; your marginal cost is electricity, not an invoice per query. For high-volume knowledge work, that changes the whole economic model.
- **CTA:** Calculate Your ROI
- **Hashtags:** #TCO #EnterpriseAI #LocalLLM #FinOps
- **Image suggestion:** A taxi meter labeled "per token" vs a flat "owned" icon.
- **Carousel suggestion:** "The hidden cost curve of metered AI."
- **Video suggestion:** 20s animation of a rising meter vs a flat line.

**TR**
- **Hook:** Jeton başı fiyatlandırma, ekibinizin sorduğu her soruyu sessizce vergilendirir.
- **Body:** Sayaçlı bulut yapay zekâ, ne kadar yararlı olursa o kadar pahalıya mal olur — benimsemeyi cezalandıran bir sayaç. Yerel çıkarımın jeton başı faturası yoktur; marjinal maliyetiniz sorgu başına fatura değil, elektriktir. Yüksek hacimli bilgi işi için bu, tüm ekonomik modeli değiştirir.
- **CTA:** ROI'nizi Hesaplayın
- **Hashtags:** #ToplamMaliyet #KurumsalYapayZeka #YerelLLM #FinOps
- **Image suggestion:** "Jeton başı" taksimetre ile düz "sahip olunan" simge.
- **Carousel suggestion:** "Sayaçlı yapay zekânın gizli maliyet eğrisi."
- **Video suggestion:** 20 sn: yükselen sayaç ile düz çizgi animasyonu.
...
- **Carousel suggestion:** "5 things a good AI audit trail must capture."
...
**EN**
- **Hook:** The average knowledge worker loses hours a week just looking for things.
- **Body:** Not thinking. Not deciding. Searching. Across an organization, that adds up to a startling amount of skilled time spent on retrieval. An answer engine turns each multi-minute hunt into a few-second, cited question — which is why knowledge search is usually the biggest line in an enterprise AI savings model.
- **CTA:** Calculate Your ROI
- **Hashtags:** #KnowledgeManagement #Productivity #EnterpriseAI #FutureOfWork
- **Image suggestion:** A clock with "search time" as a large wedge.
- **Carousel suggestion:** "Where the hours actually go."
- **Video suggestion:** 20s: time-lapse of a worker hunting files vs asking once.

**TR**
- **Hook:** Ortalama bir bilgi çalışanı, yalnızca bir şeyler ararken haftada saatler kaybeder.
- **Body:** Düşünmek değil. Karar vermek değil. Aramak. Bir kurum genelinde bu, erişime harcanan çarpıcı miktarda nitelikli zamana ulaşır. Yanıt motoru her çok-dakikalık avı birkaç saniyelik, kaynaklı bir soruya dönüştürür — bu yüzden bilgi arama, kurumsal yapay zekâ tasarruf modelinde genellikle en büyük kalemdir.
- **CTA:** ROI'nizi Hesaplayın
- **Hashtags:** #BilgiYönetimi #Verimlilik #KurumsalYapayZeka #İşinGeleceği
- **Image suggestion:** Büyük bir dilimi "arama süresi" olan bir saat.
- **Carousel suggestion:** "Saatler aslında nereye gidiyor."
- **Video suggestion:** 20 sn: dosya arayan bir çalışanın hızlandırılmış görüntüsü ile tek soru.

## Week 45 · Post 1 (Educational)
**EN**
- **Hook:** "Offline-first" isn't a limitation. It's a guarantee.
- **Body:** Designing AI to run fully air-gapped forces a discipline: no hidden cloud calls, no silent data egress, no dependency you don't control. AdOS is built that way, so "works with no internet" and "your data never leaves" are the same promise, kept by architecture rather than policy.
- **CTA:** See the Platform
- **Hashtags:** #OfflineAI #AirGap #OnPremAI #EnterpriseAI
- **Image suggestion:** A padlock formed from a broken cloud icon.
- **Carousel suggestion:** "What 'offline-first' really guarantees."
- **Video suggestion:** 25s explainer on offline-first discipline.

**TR**
- **Hook:** "Çevrimdışı öncelikli" bir kısıt değildir. Bir güvencedir.
- **Body:** Yapay zekâyı tamamen hava boşluklu çalışacak şekilde tasarlamak bir disiplin dayatır: gizli bulut çağrıları yok, sessiz veri çıkışı yok, denetlemediğiniz bağımlılık yok. AdOS bu şekilde kurulmuştur; böylece "internetsiz çalışır" ve "veriniz hiç çıkmaz" aynı sözdür, politikayla değil mimariyle tutulur.
- **CTA:** Platformu Keşfedin
- **Hashtags:** #ÇevrimdışıYapayZeka #HavaBoşluğu #KurumİçiYapayZeka #KurumsalYapayZeka
- **Image suggestion:** Kırık bir bulut simgesinden oluşan bir asma kilit.
- **Carousel suggestion:** "'Çevrimdışı öncelikli' gerçekte neyi garanti eder."
- **Video suggestion:** 25 sn çevrimdışı-öncelikli disiplin anlatımı.

## Week 45 · Post 2 (Enterprise)
**EN**
- **Hook:** Multi-site, multi-unit, one sovereign AI.
- **Body:** Large organizations aren't monoliths. AdOS is multi-tenant with strict isolation, so one deployment can serve many business units — each with its own data boundary, its own permissions, its own Company Brain — without anyone's data bleeding into anyone else's. Sovereignty scales down to the unit, not just up to the enterprise.
- **CTA:** Talk to Sales
- **Hashtags:** #EnterpriseAI #MultiTenant #DataIsolation #SovereignAI
- **Image suggestion:** One platform serving separated, walled units.
- **Carousel suggestion:** "How one AdOS serves many units safely."
- **Video suggestion:** 30s diagram of isolated tenants under one system.

**TR**
- **Hook:** Çok tesisli, çok birimli, tek egemen yapay zekâ.
- **Body:** Büyük kurumlar tek parça değildir. AdOS, sıkı yalıtımla çok kiracılıdır; böylece tek bir kurulum birçok iş birimine hizmet edebilir — her biri kendi veri sınırı, kendi izinleri, kendi Company Brain'iyle — kimsenin verisi bir başkasınınkine karışmadan. Egemenlik yalnızca kuruma değil, birime kadar iner.
- **CTA:** Satışla Görüşün
- **Hashtags:** #KurumsalYapayZeka #ÇokKiracılı #VeriYalıtımı #EgemenYapayZeka
- **Image suggestion:** Ayrılmış, duvarlı birimlere hizmet veren tek platform.
- **Carousel suggestion:** "Tek AdOS birçok birime nasıl güvenle hizmet eder."
- **Video suggestion:** 30 sn tek sistem altında yalıtılmış kiracılar diyagramı.

## Week 45 · Post 3 (Behind the scenes)
**EN**
- **Hook:** We test AdOS the way a customer meets it: pull the cable.
- **Body:** Part of our internal checklist is running the whole demo world air-gapped, then resetting it to an identical, deterministic state. If it can't answer offline and reset cleanly, it's not ready. Boring rigor is what makes "your data never leaves" more than a slogan.
- **CTA:** Request a Demo
- **Hashtags:** #BehindTheScenes #Engineering #Determinism #OnPremAI
- **Image suggestion:** A checklist with "air-gap test ✓ / deterministic reset ✓".
- **Carousel suggestion:** "Our pre-demo checklist."
- **Video suggestion:** 20s: reset the demo, same state every time.

**TR**
- **Hook:** AdOS'u müşterinin karşılaştığı gibi test ederiz: kabloyu çek.
- **Body:** İç kontrol listemizin bir parçası, tüm demo dünyasını hava boşluklu çalıştırıp ardından onu birebir, belirlenimci bir duruma sıfırlamaktır. Çevrimdışı yanıtlayamıyor ve temiz sıfırlanamıyorsa hazır değildir. "Veriniz hiç çıkmaz"ı bir slogandan fazlası yapan, sıkıcı titizliktir.
- **CTA:** Demo Talep Edin
- **Hashtags:** #PerdeArkası #Mühendislik #Belirlenimcilik #KurumİçiYapayZeka
- **Image suggestion:** "hava boşluğu testi ✓ / belirlenimci sıfırlama ✓" içeren bir kontrol listesi.
- **Carousel suggestion:** "Demo öncesi kontrol listemiz."
- **Video suggestion:** 20 sn: demoyu sıfırla, her seferinde aynı durum.

## Week 46 · Post 1 (AI)
**EN**
- **Hook:** You should own your model, not rent your dependence on someone else's.
- **Body:** AdOS runs open, local models through a standard local engine. You choose the model, and you can swap it as the open ecosystem improves — no re-architecture, no vendor holding your capability hostage. Open engines, an OpenAI-compatible interface, portable data. No lock-in by design.
- **CTA:** Read the Guide
- **Hashtags:** #OpenSource #LocalLLM #NoVendorLockIn #EnterpriseAI
- **Image suggestion:** A model chip you can lift out and replace.
- **Carousel suggestion:** "How to avoid AI vendor lock-in."
- **Video suggestion:** 25s: swapping the local model like a cartridge.

**TR**
- **Hook:** Modelinizi kiralamamalı, ona sahip olmalısınız — başkasınınkine bağımlılığınızı değil.
- **Body:** AdOS, açık ve yerel modelleri standart bir yerel motor üzerinden çalıştırır. Modeli siz seçersiniz ve açık ekosistem geliştikçe değiştirebilirsiniz — yeniden mimari yok, yeteneğinizi rehin tutan bir tedarikçi yok. Açık motorlar, OpenAI uyumlu arayüz, taşınabilir veri. Tasarımı gereği bağımlılık yok.
- **CTA:** Rehberi Okuyun
- **Hashtags:** #AçıkKaynak #YerelLLM #TedarikçiBağımlılığıYok #KurumsalYapayZeka
- **Image suggestion:** Çıkarıp değiştirebileceğiniz bir model çipi.
- **Carousel suggestion:** "Yapay zekâ tedarikçi bağımlılığından nasıl kaçınılır."
- **Video suggestion:** 25 sn: yerel modeli kartuş gibi değiştirmek.

## Week 46 · Post 2 (Customer story — illustrative)
**EN**
- **Hook:** An OSB shared-services team (illustrative) gave member firms one sovereign AI.
- **Body:** In an illustrative scenario, an organized industrial zone ran a Company Brain for its member companies' shared procedures and permits — each firm seeing only its own entitled documents, all of it on-prem. One deployment, many tenants, zero data crossing between them. The model fits shared-services realities without sharing the data.
- **CTA:** Talk to Sales
- **Hashtags:** #OSB #SharedServices #MultiTenant #SovereignAI
- **Image suggestion:** A zone map with isolated member-firm nodes. (Illustrative.)
- **Carousel suggestion:** "Illustrative: sovereign AI as a shared service."
- **Video suggestion:** 30s illustrative walk-through, captioned.

**TR**
- **Hook:** Bir OSB paylaşımlı hizmet ekibi (temsili) üye firmalara tek egemen yapay zekâ verdi.
- **Body:** Temsili bir senaryoda, bir organize sanayi bölgesi üye şirketlerinin paylaşımlı prosedürleri ve ruhsatları için bir Company Brain çalıştırdı — her firma yalnızca kendi yetkili belgelerini görüyor, hepsi kurum içinde. Tek kurulum, çok kiracı, aralarında sıfır veri geçişi. Model, veriyi paylaşmadan paylaşımlı-hizmet gerçeklerine uyar.
- **CTA:** Satışla Görüşün
- **Hashtags:** #OSB #PaylaşımlıHizmet #ÇokKiracılı #EgemenYapayZeka
- **Image suggestion:** Yalıtılmış üye-firma düğümleriyle bir bölge haritası. (Temsili.)
- **Carousel suggestion:** "Temsili: paylaşımlı hizmet olarak egemen yapay zekâ."
- **Video suggestion:** 30 sn temsili tanıtım, altyazılı.

## Week 46 · Post 3 (Founder perspective)
**EN**
- **Hook:** The best compliment we get: "So my data really never leaves?"
- **Body:** Yes. Really. It's the question every serious buyer asks, usually twice, because the market trained them to expect a catch. There isn't one. On your hardware, offline-capable, no external API. When the honest answer is simply "correct," you've built the right thing.
- **CTA:** Request a Demo
- **Hashtags:** #FounderMindset #DataSovereignty #EnterpriseAI #Trust
- **Image suggestion:** Quote card, minimal.
- **Carousel suggestion:** "The questions buyers ask twice."
- **Video suggestion:** 30s founder answering the recurring question.

**TR**
- **Hook:** Aldığımız en güzel iltifat: "Yani verim gerçekten hiç çıkmıyor mu?"
- **Body:** Evet. Gerçekten. Her ciddi alıcının sorduğu — genelde iki kez — sorudur; çünkü piyasa onlara bir bit yeniği beklemeyi öğretti. Yok. Kendi donanımınızda, çevrimdışı uyumlu, harici API yok. Dürüst yanıt sadece "doğru" olduğunda, doğru şeyi kurmuşsunuzdur.
- **CTA:** Demo Talep Edin
- **Hashtags:** #KurucuBakışı #VeriEgemenliği #KurumsalYapayZeka #Güven
- **Image suggestion:** Sade alıntı kartı.
- **Carousel suggestion:** "Alıcıların iki kez sorduğu sorular."
- **Video suggestion:** 30 sn kurucu tekrarlanan soruyu yanıtlıyor.

## Week 47 · Post 1 (Educational)
**EN**
- **Hook:** Three words that decide most enterprise AI projects: where's the data?
- **Body:** Capability rarely kills an enterprise AI project. Data governance does. If adopting AI means your knowledge leaves the building, security and legal will — rightly — slow it down. Put the AI on your infrastructure and that objection disappears, because the answer to "where's the data?" is "exactly where it always was."
- **CTA:** See the Platform
- **Hashtags:** #DataGovernance #EnterpriseAI #OnPremAI #CISO
- **Image suggestion:** A gate labeled "governance" opening once data stays inside.
- **Carousel suggestion:** "Why AI projects stall at security review."
- **Video suggestion:** 25s explainer on the governance blocker.

**TR**
- **Hook:** Çoğu kurumsal yapay zekâ projesini belirleyen üç kelime: veri nerede?
- **Body:** Kurumsal bir yapay zekâ projesini nadiren yetenek öldürür. Veri yönetişimi öldürür. Yapay zekâyı benimsemek bilginizin binadan çıkması demekse, güvenlik ve hukuk — haklı olarak — yavaşlatır. Yapay zekâyı altyapınıza koyun; "veri nerede?" sorusunun yanıtı "her zaman olduğu yerde" olduğundan bu itiraz kaybolur.
- **CTA:** Platformu Keşfedin
- **Hashtags:** #VeriYönetişimi #KurumsalYapayZeka #KurumİçiYapayZeka #CISO
- **Image suggestion:** Veri içeride kalınca açılan "yönetişim" kapısı.
- **Carousel suggestion:** "Yapay zekâ projeleri güvenlik incelemesinde neden takılır."
- **Video suggestion:** 25 sn yönetişim engeli anlatımı.
...
- **Carousel suggestion:** "Healthcare AI: the confidentiality checklist."
- **Video suggestion:** 20s: patient record stays inside the hospital boundary.
...
- **Carousel suggestion:** "Sağlıkta yapay zekâ: gizlilik kontrol listesi."
- **Video suggestion:** 20 sn: hasta kaydı hastane sınırı içinde kalıyor.
...
- **Carousel suggestion:** "Why your wiki failed — and what replaces it."
- **Video suggestion:** 25s: buried doc surfaced as an instant answer.
...
- **Carousel suggestion:** "Wiki'niz neden başarısız oldu — ve yerine ne geçer."
- **Video suggestion:** 25 sn: gömülü belge anında yanıt olarak yüzeye çıkıyor.

## Week 48 · Post 2 (Security)
**EN**
- **Hook:** "Air-gap capable" is a sentence that ends a lot of RFP debates.
- **Body:** Some environments simply cannot touch the internet — defense-adjacent, critical infrastructure, sensitive public data. AdOS runs fully offline, so it qualifies where cloud AI is a non-starter. If your requirement is "no external connectivity, ever," that's not a workaround for us; it's the default.
- **CTA:** Read the Guide
- **Hashtags:** #AirGap #CriticalInfrastructure #CyberSecurity #OnPremAI
- **Image suggestion:** An isolated network with no outbound arrow.
- **Carousel suggestion:** "When air-gap is non-negotiable."
- **Video suggestion:** 20s: system running on a fully isolated network.

**TR**
- **Hook:** "Hava boşluğu uyumlu" cümlesi birçok RFP tartışmasını bitirir.
- **Body:** Bazı ortamlar internete hiç dokunamaz — savunmaya yakın, kritik altyapı, hassas kamu verisi. AdOS tamamen çevrimdışı çalışır; böylece bulut yapay zekânın olanaksız olduğu yerlerde uygun olur. Gereksiniminiz "hiçbir zaman harici bağlantı yok" ise, bu bizim için bir geçici çözüm değil; varsayılandır.
- **CTA:** Rehberi Okuyun
- **Hashtags:** #HavaBoşluğu #KritikAltyapı #SiberGüvenlik #KurumİçiYapayZeka
- **Image suggestion:** Dışa ok olmayan yalıtılmış bir ağ.
- **Carousel suggestion:** "Hava boşluğunun pazarlık edilemez olduğu durumlar."
- **Video suggestion:** 20 sn: tamamen yalıtılmış bir ağda çalışan sistem.

## Week 48 · Post 3 (Enterprise)
**EN**
- **Hook:** Pilot on your own hardware. That's the whole risk test.
- **Body:** The fastest way to de-risk enterprise AI is to run it where it will live: your infrastructure, your data, your security review. Because AdOS is on-prem and offline-capable, a pilot isn't a cloud trial with your data on someone else's servers — it's the real thing, contained, from day one.
- **CTA:** Talk to Sales
- **Hashtags:** #EnterpriseAI #Pilot #OnPremAI #RiskManagement
- **Image suggestion:** A contained sandbox inside the customer's own datacenter.
- **Carousel suggestion:** "How to run a safe enterprise AI pilot."
- **Video suggestion:** 30s: pilot spun up inside the customer boundary.

**TR**
- **Hook:** Kendi donanımınızda pilot yapın. Bütün risk testi budur.
- **Body:** Kurumsal yapay zekânın riskini azaltmanın en hızlı yolu, onu yaşayacağı yerde çalıştırmaktır: altyapınız, verileriniz, güvenlik incelemeniz. AdOS kurum içi ve çevrimdışı uyumlu olduğundan, bir pilot verinizin başkasının sunucularında olduğu bir bulut denemesi değil — ilk günden itibaren kapsanmış, gerçek olanıdır.
- **CTA:** Satışla Görüşün
- **Hashtags:** #KurumsalYapayZeka #Pilot #KurumİçiYapayZeka #RiskYönetimi
- **Image suggestion:** Müşterinin kendi veri merkezinde kapsanmış bir kum havuzu.
- **Carousel suggestion:** "Güvenli bir kurumsal yapay zekâ pilotu nasıl yürütülür."
- **Video suggestion:** 30 sn: müşteri sınırı içinde başlatılan pilot.

## Week 49 · Post 1 (Year in review)
**EN**
- **Hook:** This year, sovereign AI went from "interesting" to "required."
- **Body:** Twelve months ago, keeping AI on your own infrastructure was a niche stance. Now it's a procurement criterion. The organizations moving fastest aren't the ones chasing the flashiest model — they're the ones who solved data governance first and adopted AI they fully control. That's the shift AdOS was built for.
- **CTA:** See the Platform
- **Hashtags:** #YearInReview #SovereignAI #EnterpriseAI #OnPremAI
- **Image suggestion:** A simple timeline arc from "niche" to "standard."
- **Carousel suggestion:** "The year sovereign AI became the default."
- **Video suggestion:** 30s year-in-review montage (abstract, no stock clichés).

**TR**
- **Hook:** Bu yıl egemen yapay zekâ "ilginç"ten "gerekli"ye geçti.
- **Body:** On iki ay önce yapay zekâyı kendi altyapınızda tutmak niş bir duruştu. Şimdi bir satın alma ölçütü. En hızlı ilerleyen kurumlar en gösterişli modeli kovalayanlar değil — önce veri yönetişimini çözüp tamamen denetledikleri yapay zekâyı benimseyenler. AdOS'un kurulduğu değişim budur.
- **CTA:** Platformu Keşfedin
- **Hashtags:** #YılınÖzeti #EgemenYapayZeka #KurumsalYapayZeka #KurumİçiYapayZeka
- **Image suggestion:** "Niş"ten "standart"a giden basit bir zaman çizelgesi yayı.
- **Carousel suggestion:** "Egemen yapay zekânın varsayılan olduğu yıl."
- **Video suggestion:** 30 sn yılın özeti kolajı (soyut, klişe stok yok).

## Week 49 · Post 2 (AI)
**EN**
- **Hook:** The frontier will keep moving. Your architecture shouldn't have to.
- **Body:** Models improve monthly; that's a reason to stay portable, not to rent lock-in. AdOS runs open local models through a standard interface, so you adopt the next better model without re-platforming. Own the architecture, swap the model. The frontier races; your foundation holds.
- **CTA:** Read the Guide
- **Hashtags:** #AI #LocalLLM #Futureproofing #EnterpriseAI
- **Image suggestion:** A stable base with interchangeable model blocks on top.
- **Carousel suggestion:** "Futureproofing enterprise AI."
- **Video suggestion:** 25s: models swapping while the platform stays put.

**TR**
- **Hook:** Sınır ilerlemeye devam edecek. Mimariniz buna mecbur olmamalı.
- **Body:** Modeller her ay gelişir; bu, taşınabilir kalmanın nedenidir, bağımlılık kiralamanın değil. AdOS açık yerel modelleri standart bir arayüz üzerinden çalıştırır; böylece bir sonraki daha iyi modeli yeniden platform kurmadan benimsersiniz. Mimariye sahip olun, modeli değiştirin. Sınır yarışır; temeliniz durur.
- **CTA:** Rehberi Okuyun
- **Hashtags:** #YapayZeka #YerelLLM #GeleceğeHazırlık #KurumsalYapayZeka
- **Image suggestion:** Üstünde değiştirilebilir model blokları olan sabit bir taban.
- **Carousel suggestion:** "Kurumsal yapay zekâyı geleceğe hazırlamak."
- **Video suggestion:** 25 sn: platform yerinde dururken modeller değişiyor.

## Week 49 · Post 3 (Community)
**EN**
- **Hook:** Sovereign AI is a practice, not just a product. Let's compare notes.
- **Body:** IT and security leaders running AI on their own infrastructure are learning fast — about hardware sizing, model choice, permission design, day-2 ops. We're building a space to share what works, honestly, without the hype. If you're doing on-prem AI in the enterprise, we'd like to learn from you too.
- **CTA:** Talk to Sales
- **Hashtags:** #Community #OnPremAI #CISO #ITLeadership
- **Image suggestion:** A round-table motif, abstract.
- **Carousel suggestion:** "5 hard-won lessons from on-prem AI teams."
- **Video suggestion:** 30s invitation to the practitioner community.

**TR**
- **Hook:** Egemen yapay zekâ yalnızca bir ürün değil, bir pratiktir. Deneyimleri paylaşalım.
- **Body:** Yapay zekâyı kendi altyapısında çalıştıran BT ve güvenlik liderleri hızla öğreniyor — donanım boyutlandırma, model seçimi, izin tasarımı, ikinci-gün operasyonları. Neyin işe yaradığını dürüstçe, abartısız paylaşacak bir alan kuruyoruz. Kurumda kurum içi yapay zekâ yapıyorsanız, sizden de öğrenmek isteriz.
- **CTA:** Satışla Görüşün
- **Hashtags:** #Topluluk #KurumİçiYapayZeka #CISO #BTLiderliği
- **Image suggestion:** Soyut bir yuvarlak masa motifi.
- **Carousel suggestion:** "Kurum içi yapay zekâ ekiplerinden 5 zorlu ders."
- **Video suggestion:** 30 sn uygulayıcı topluluğuna davet.

## Week 50 · Post 1 (Educational)
**EN**
- **Hook:** ROI from AI isn't magic. It's recovered hours you can name.
- **Body:** The honest way to model AI value is to add up the hours it gives back: knowledge search, manual routing, approval delay, onboarding. Multiply by loaded cost, scale by realistic adoption, subtract the investment. No hype — a model you control, with assumptions you can see and change. That's how we present ROI.
- **CTA:** Calculate Your ROI
- **Hashtags:** #ROI #EnterpriseAI #Productivity #FinOps
- **Image suggestion:** A simple savings-breakdown bar chart.
- **Carousel suggestion:** "How to model AI ROI honestly."
- **Video suggestion:** 30s walkthrough of the ROI inputs.

**TR**
- **Hook:** Yapay zekâdan ROI sihir değildir. Adını koyabileceğiniz geri kazanılan saatlerdir.
- **Body:** Yapay zekâ değerini modellemenin dürüst yolu, geri verdiği saatleri toplamaktır: bilgi arama, manuel yönlendirme, onay gecikmesi, işe alıştırma. Tüm maliyetle çarpın, gerçekçi benimsemeyle ölçekleyin, yatırımı çıkarın. Abartı yok — görebildiğiniz ve değiştirebildiğiniz varsayımlarla kontrol sizde. ROI'yi böyle sunarız.
- **CTA:** ROI'nizi Hesaplayın
- **Hashtags:** #ROI #KurumsalYapayZeka #Verimlilik #FinOps
- **Image suggestion:** Basit bir tasarruf-dağılımı çubuk grafiği.
- **Carousel suggestion:** "Yapay zekâ ROI'si dürüstçe nasıl modellenir."
- **Video suggestion:** 30 sn ROI girdilerinin gezinimi.

## Week 50 · Post 2 (Product)
**EN**
- **Hook:** One command to set up. One command to reset. Every time identical.
- **Body:** Our demo world is deterministic: seed it, and you get the same internally-consistent enterprise every time; reset it, and it returns to a known-good state. Boring? Yes. Reliable demos and clean environments are boring on purpose — and that's exactly what enterprise buyers want to see.
- **CTA:** Request a Demo
- **Hashtags:** #ProductDemo #Determinism #Reliability #EnterpriseAI
- **Image suggestion:** A reset button restoring an identical dashboard.
- **Carousel suggestion:** "Why a deterministic demo matters."
- **Video suggestion:** 20s: reset → identical state.

**TR**
- **Hook:** Kurmak için tek komut. Sıfırlamak için tek komut. Her seferinde birebir aynı.
- **Body:** Demo dünyamız belirlenimcidir: tohumlayın, her seferinde aynı kendi içinde tutarlı kurumu elde edersiniz; sıfırlayın, bilinen-iyi bir duruma döner. Sıkıcı mı? Evet. Güvenilir demolar ve temiz ortamlar bilerek sıkıcıdır — ve kurumsal alıcıların görmek istediği tam olarak budur.
- **CTA:** Demo Talep Edin
- **Hashtags:** #ÜrünDemosu #Belirlenimcilik #Güvenilirlik #KurumsalYapayZeka
- **Image suggestion:** Birebir aynı panoyu geri getiren bir sıfırlama düğmesi.
- **Carousel suggestion:** "Belirlenimci bir demo neden önemli."
- **Video suggestion:** 20 sn: sıfırla → birebir aynı durum.

## Week 50 · Post 3 (Industry insight)
**EN**
- **Hook:** Finance doesn't ask "is the AI smart?" It asks "can we prove what it did?"
- **Body:** In regulated finance, auditability outranks cleverness. AdOS records every consequential action in an immutable trail and grounds every answer in a citation the asker is entitled to. When the regulator asks what happened, the answer is a record, not a reconstruction — and none of the data ever left the institution.
- **CTA:** Talk to Sales
- **Hashtags:** #Finance #Auditability #Compliance #OnPremAI
- **Image suggestion:** A ledger and a citation link side by side.
- **Carousel suggestion:** "What finance really needs from enterprise AI."
- **Video suggestion:** 25s: an audit query answered from the trail.

**TR**
- **Hook:** Finans "yapay zekâ akıllı mı?" diye sormaz. "Ne yaptığını kanıtlayabilir miyiz?" diye sorar.
- **Body:** Düzenlemeye tabi finansta denetlenebilirlik, zekâdan önce gelir. AdOS sonuç doğuran her eylemi değiştirilemez bir izde kaydeder ve her yanıtı, soranın yetkili olduğu bir alıntıya dayandırır. Düzenleyici ne olduğunu sorduğunda yanıt bir yeniden kurgu değil, bir kayıttır — ve verilerin hiçbiri kurumdan çıkmamıştır.
- **CTA:** Satışla Görüşün
- **Hashtags:** #Finans #Denetlenebilirlik #Uyum #KurumİçiYapayZeka
- **Image suggestion:** Yan yana bir kayıt defteri ve bir alıntı bağlantısı.
- **Carousel suggestion:** "Finansın kurumsal yapay zekâdan gerçekte ihtiyacı olan."
- **Video suggestion:** 25 sn: izden yanıtlanan bir denetim sorgusu.

## Week 51 · Post 1 (Founder perspective)
**EN**
- **Hook:** We measured our year in one number: demos that ran with the cable pulled.
- **Body:** Not downloads. Not impressions. The moment a buyer watched AdOS answer with the network unplugged and understood — this really does stay in my building. That look is the whole thesis. Thank you to everyone who let us pull the cable in their conference room this year.
- **CTA:** Request a Demo
- **Hashtags:** #FounderMindset #YearInReview #SovereignAI #Gratitude
- **Image suggestion:** A single unplugged cable, warm tone.
- **Carousel suggestion:** "Our favorite moments from a year of demos."
- **Video suggestion:** 40s founder reflection.

**TR**
- **Hook:** Yılımızı tek bir sayıyla ölçtük: kablo çekiliyken çalışan demolar.
- **Body:** İndirmeler değil. Gösterimler değil. Bir alıcının, ağ çekilmişken AdOS'un yanıtladığını izleyip anladığı an — bu gerçekten benim binamda kalıyor. O bakış, tüm tezimiz. Bu yıl toplantı odasında kabloyu çekmemize izin veren herkese teşekkürler.
- **CTA:** Demo Talep Edin
- **Hashtags:** #KurucuBakışı #YılınÖzeti #EgemenYapayZeka #Teşekkür
- **Image suggestion:** Sıcak tonda, çekilmiş tek bir kablo.
- **Carousel suggestion:** "Bir yıllık demolardan en sevdiğimiz anlar."
- **Video suggestion:** 40 sn kurucu değerlendirmesi.
...
- **Carousel suggestion:** "Our fixed rule, our moving roadmap."
- **Video suggestion:** 30s teaser (abstract, no overpromising).
...
- **Carousel suggestion:** "Sabit kuralımız, hareketli yol haritamız."
- **Video suggestion:** 30 sn fragman (soyut, aşırı vaat yok).

## Week 51 · Post 3 (Knowledge)
**EN**
- **Hook:** The knowledge you protect most is the knowledge you can least afford to send away.
- **Body:** Trade secrets, patient records, financial models, citizen data — the more valuable the knowledge, the less acceptable it is to upload it. That's the paradox cloud AI can't resolve and on-prem AI is built for. A Company Brain makes your most sensitive knowledge answerable without making it leave.
- **CTA:** Talk to Sales
- **Hashtags:** #KnowledgeManagement #DataSovereignty #CompanyBrain #EnterpriseAI
- **Image suggestion:** A vault that answers questions from inside.
- **Carousel suggestion:** "Your most valuable knowledge is your least cloud-safe."
- **Video suggestion:** 25s: sensitive vault answering, never opening outward.

**TR**
- **Hook:** En çok koruduğunuz bilgi, göndermeyi en az göze alabileceğiniz bilgidir.
- **Body:** Ticari sırlar, hasta kayıtları, finansal modeller, vatandaş verisi — bilgi ne kadar değerliyse yüklemek o kadar kabul edilemez. Bu, bulut yapay zekânın çözemediği, kurum içi yapay zekânın kurulduğu paradokstur. Company Brain en hassas bilginizi çıkarmadan yanıtlanabilir kılar.
- **CTA:** Satışla Görüşün
- **Hashtags:** #BilgiYönetimi #VeriEgemenliği #CompanyBrain #KurumsalYapayZeka
- **Image suggestion:** İçeriden soruları yanıtlayan bir kasa.
- **Carousel suggestion:** "En değerli bilginiz, buluta en az güvenli olanıdır."
- **Video suggestion:** 25 sn: hassas kasa yanıtlıyor, dışa hiç açılmıyor.
...
- **Carousel suggestion:** "Your enterprise AI evaluation checklist for next year."
- **Video suggestion:** 30s: the one question to lead every evaluation.

**TR**
- **Hook:** Gelecek yıl kurumsal yapay zekâ hakkında tek şeyi değerlendirecekseniz, veri yolunu değerlendirin.
- **Body:** Modeller etkilemeye devam edecek. Kalıcı soru mimaridir: bilginiz binadan çıkıyor mu, çıkmıyor mu? Her yapay zekâ değerlendirmesine oradan başlayın. Yanıt "tamamen kalıyor, çevrimdışı uyumlu, izin-farkında ve denetleniyor" ise, bir kurumsal yapay zekâ işletim sistemine bakıyorsunuz — ki AdOS tam olarak budur.
- **CTA:** Platformu Keşfedin
- **Hashtags:** #KurumsalYapayZeka #VeriEgemenliği #KurumİçiYapayZeka #Strateji
- **Image suggestion:** "önce veri yolunu değerlendirin" başlıklı bir kontrol listesi.
- **Carousel suggestion:** "Gelecek yıl için kurumsal yapay zekâ değerlendirme listeniz."
- **Video suggestion:** 30 sn: her değerlendirmeye öncülük edecek tek soru.

## Week 52 · Post 2 (Gratitude / community)
**EN**
- **Hook:** Thank you for a year of asking the hard question: "but where does the data go?"
- **Body:** That question drove every conversation we valued this year. To the IT leaders, CISOs, and operators who refused to hand their data to someone else's cloud: you're the reason sovereign AI is becoming the standard. Here's to a new year of capable AI that stays exactly where it belongs — with you.
- **CTA:** Talk to Sales
- **Hashtags:** #Gratitude #Community #SovereignAI #EnterpriseAI
- **Image suggestion:** A simple thank-you card, brand-dark.
- **Carousel suggestion:** "Thank you — a year in questions."
- **Video suggestion:** 30s team thank-you (abstract, warm).

**TR**
- **Hook:** Zor soruyu sorduğunuz bir yıl için teşekkürler: "peki veri nereye gidiyor?"
- **Body:** Bu soru, bu yıl değer verdiğimiz her sohbeti yönlendirdi. Verisini bir başkasının bulutuna vermeyi reddeden BT liderlerine, CISO'lara ve operatörlere: egemen yapay zekânın standart hâline gelmesinin nedeni sizsiniz. Tam ait olduğu yerde — sizde — kalan yetenekli yapay zekâyla dolu bir yeni yıla.
- **CTA:** Satışla Görüşün
- **Hashtags:** #Teşekkür #Topluluk #EgemenYapayZeka #KurumsalYapayZeka
- **Image suggestion:** Marka-koyu, sade bir teşekkür kartı.
- **Carousel suggestion:** "Teşekkürler — sorularla bir yıl."
- **Video suggestion:** 30 sn ekip teşekkürü (soyut, sıcak).
...
- **Carousel suggestion:** "Your on-prem AI checklist for the new year."
- **Video suggestion:** 30s forward-looking close, cable-pull motif.

**TR**
- **Hook:** Yeni yıla sahip olduğunuz yapay zekâyla başlayın — bağımlılığınızı kiraladığınızla değil.
- **Body:** Tutmaya değer bir karar: yapay zekâyı kendi koşullarınızda benimseyin. Altyapınızda. Çevrimdışı uyumlu. İzin-farkında. Kaynaklı. Sayaçsız. Veri binadan çıkmadan. Yeni yıl listenizde bu varsa, ilk adım kabloyu çektiğimiz ve çalışmaya devam ettiği bir demodur.
- **CTA:** Demo Talep Edin
- **Hashtags:** #KurumsalYapayZeka #EgemenYapayZeka #KurumİçiYapayZeka #YeniYıl
- **Image suggestion:** Verinin içeride kaldığı, yeni bir yıla açılan bir kapı.
- **Carousel suggestion:** "Yeni yıl için kurum içi yapay zekâ kontrol listeniz."
- **Video suggestion:** 30 sn ileriye dönük kapanış, kablo-çekme motifi.
